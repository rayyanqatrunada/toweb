...
```mermaid
graph TD
    Website[Platform Digital Website TSM SMKN 1 Bangsri]
    
    Website --> Stakeholder1[Calon Siswa & Orang Tua: Transparansi & Orientasi Karir]
    Website --> Stakeholder2[Siswa Aktif TSM: Pusat Pembelajaran & Info PKL]
    Website --> Stakeholder3[Mitra Industri & AHASS: Rekrutmen & Sinergi Kurikulum]
    Website --> Stakeholder4[Alumni: Karir BKK & Jejaring Profesional]
    Website --> Stakeholder5[Sekolah & Jurusan: Akreditasi & Status SMK PK]
```
