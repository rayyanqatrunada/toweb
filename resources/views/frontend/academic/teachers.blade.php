<x-layouts.app title="Struktur Organisasi & Dewan Guru {{ $settings->get('site_short_name', 'TSM') }}">
    ...
    <section class="relative bg-gradient-to-b from-slate-100/90 via-white to-slate-50 overflow-hidden border-b border-slate-200/80 pt-8 pb-10 sm:pt-12 sm:pb-16 lg:pt-20 lg:pb-24">
        ...
        <x-frontend.layout.container class="relative z-10 px-4 sm:px-6 md:px-8">
            ...
            <div class="max-w-4xl">
                <div class="inline-flex items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-sm sm:rounded-[2px] bg-white border border-slate-200 shadow-sm mb-4 sm:mb-6 reveal-on-scroll reveal-up">
                ...
                <div class="flex flex-wrap items-center gap-2.5 sm:gap-4 mt-6 sm:mt-8 reveal-on-scroll reveal-up delay-300">
                    <a href="#bagan-organisasi" class="inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 rounded-sm sm:rounded-[2px] bg-slate-900 text-white font-heading font-bold text-xs uppercase tracking-wider hover:bg-red-600 shadow-md hover:shadow-xl transition-all duration-300 active:scale-95">
                    ...
                    <a href="#direktori-guru" class="inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 rounded-sm sm:rounded-[2px] bg-white text-slate-800 border border-slate-300 font-heading font-bold text-xs uppercase tracking-wider hover:border-slate-400 hover:bg-slate-50 shadow-sm transition-all duration-300 active:scale-95">
            ...
            <div class="mt-8 sm:mt-14 pt-6 sm:pt-8 border-t border-slate-200/80 grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-6 reveal-on-scroll reveal-up delay-300">
                <div class="flex items-center gap-3 sm:gap-3.5">
                    <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-sm bg-red-50 border border-red-100 flex items-center justify-center text-red-600 font-black text-lg sm:text-xl font-heading shrink-0">
                        {{ count($teachers) }}
                    </div>
                    <div>
                ...
                <div class="flex items-center gap-3 sm:gap-3.5">
                    <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-sm bg-amber-50 border border-amber-100 flex items-center justify-center text-amber-600 font-black text-lg sm:text-xl font-heading shrink-0">
                        AHM
                    </div>
                    <div>
                ...
                <div class="flex items-center gap-3 sm:gap-3.5">
                    <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-sm bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-600 font-black text-lg sm:text-xl font-heading shrink-0">
                        BNSP
                    </div>
                    <div>
                ...
                <div class="flex items-center gap-3 sm:gap-3.5">
                    <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-sm bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 font-black text-lg sm:text-xl font-heading shrink-0">
                        5R
                    </div>
                    <div>
    ...
    <section id="bagan-organisasi" class="py-14 sm:py-20 lg:py-28 bg-slate-100/60 relative overflow-hidden border-b border-slate-200" x-data="{ activeTab: (window.innerWidth < 768 ? 'cards' : 'tree') }">
        ...
        <x-frontend.layout.container>
            ...
            <div class="flex flex-col lg:flex-row lg:items-end justify-between mb-8 sm:mb-10 gap-6 reveal-on-scroll reveal-up">
                ...
                <div class="flex items-center w-full sm:w-auto bg-white p-1 rounded-sm sm:rounded-none border border-slate-200/90 shadow-sm shrink-0 self-start lg:self-end">
                    <button 
                        @click="activeTab = 'tree'" 
                        :class="activeTab === 'tree' ? 'bg-slate-900 text-white shadow-md' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50'"
                        class="flex-1 sm:flex-initial px-3.5 sm:px-4 py-2.5 sm:py-2 rounded-sm text-[11px] sm:text-xs font-heading font-black uppercase tracking-wider transition-all duration-200 flex items-center justify-center gap-1.5 sm:gap-2">
            ...
            <div class="bg-slate-100/80 rounded-sm sm:rounded-none p-2 sm:p-3.5 border border-slate-200 shadow-xl shadow-slate-200/50 relative overflow-hidden">
                <div class="bg-white rounded-none p-4 sm:p-8 lg:p-12 relative overflow-hidden border border-slate-100">
                    ...
                    <div class="relative z-10 flex flex-wrap items-center justify-center sm:justify-between gap-3 pb-8 mb-8 border-b border-slate-100 text-xs">
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-sm bg-red-50 border border-red-200 text-[10px] font-bold text-red-700">
                                <span class="w-2 h-2 rounded-full bg-red-600"></span> Pimpinan
                            </span>
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-sm bg-slate-100 border border-slate-200 text-[10px] font-bold text-slate-700">
                                <span class="w-2 h-2 rounded-full bg-slate-800"></span> Pengelola
                            </span>
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-sm bg-amber-50 border border-amber-200 text-[10px] font-bold text-amber-800">
                                <span class="w-2 h-2 rounded-full bg-amber-500"></span> Kepala Lab & Bengkel
                            </span>
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-sm bg-emerald-50 border border-emerald-200 text-[10px] font-bold text-emerald-800">
                    ...
                    <div x-show="activeTab === 'tree'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                        <!-- Mobile Scroll Hint -->
                        <div class="xl:hidden flex items-center justify-center gap-2 mb-6 text-xs text-slate-600 bg-slate-50 border border-slate-200 shadow-xs px-4 py-2 rounded-sm w-fit mx-auto">
                            ...
                            <div class="min-w-[1020px] max-w-[1100px] mx-auto flex flex-col items-center relative z-10">
                                ...
                                <div class="flex flex-col items-center relative z-20">
                                    <a href="#guru-{{ $hod?->id ?? 1 }}" class="group block focus:outline-none" title="Lihat Profil {{ $hod?->name ?? 'Pimpinan Kejuruan' }}">
                                        <div class="w-80 sm:w-[340px] rounded-sm sm:rounded-none p-[1.5px] bg-gradient-to-b from-red-600 via-rose-500 to-amber-500 shadow-xl shadow-red-600/10 hover:shadow-2xl hover:shadow-red-600/20 hover:-translate-y-1.5 transition-all duration-500">
                                            <div class="bg-white rounded-sm sm:rounded-none p-5 text-center relative overflow-hidden">
                                                <!-- Top Crown Badge -->
                                                <div class="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-sm bg-gradient-to-r from-red-600 via-red-700 to-rose-700 text-white text-[9px] font-black uppercase tracking-[2px] shadow-sm mb-3.5">
                                                ...
                                                <div class="inline-block px-3 py-1 rounded-sm bg-red-50 border border-red-200 text-red-700 font-bold text-xs uppercase tracking-wider mb-2">
                                ...
                                <div class="org-tree-row max-w-[940px] mx-auto z-10">
                                    ...
                                    <div class="org-tree-col w-1/3 px-3">
                                        ...
                                        <a href="#guru-{{ $bendahara?->id ?? 2 }}" class="group block w-full max-w-[270px] focus:outline-none" title="Lihat Profil {{ $bendahara?->name ?? 'Bendahara' }}">
                                            <div class="rounded-sm sm:rounded-none p-[1px] bg-gradient-to-b from-slate-200 via-slate-100 to-slate-200 hover:from-slate-400 hover:to-slate-300 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                                <div class="bg-white rounded-sm sm:rounded-none p-4 text-center">
                                                    <div class="inline-block px-2.5 py-0.5 rounded-sm bg-slate-900 text-slate-200 text-[9px] font-black uppercase tracking-wider mb-2.5">
                                                        PENGELOLA JURUSAN
                                                    </div>
                                                    ...
                                                    <div class="inline-block px-2.5 py-0.5 rounded-sm bg-slate-100 border border-slate-200 text-slate-700 font-bold text-[11px] uppercase tracking-wider mb-1">
                                                        Bendahara
                                                    </div>
                                    ...
                                    <div class="org-tree-col w-1/3 px-3">
                                        ...
                                        <a href="#guru-{{ $sekretaris?->id ?? 3 }}" class="group block w-full max-w-[270px] focus:outline-none" title="Lihat Profil {{ $sekretaris?->name ?? 'Sekretaris' }}">
                                            <div class="rounded-sm sm:rounded-none p-[1px] bg-gradient-to-b from-slate-200 via-slate-100 to-slate-200 hover:from-red-300 hover:to-slate-300 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                                <div class="bg-white rounded-sm sm:rounded-none p-4 text-center">
                                                    <div class="inline-block px-2.5 py-0.5 rounded-sm bg-slate-900 text-slate-200 text-[9px] font-black uppercase tracking-wider mb-2.5">
                                                        PENGELOLA JURUSAN
                                                    </div>
                                    ...
                                    <div class="org-tree-col w-1/3 px-3">
                                        ...
                                        <a href="#guru-{{ $kepalaLab?->id ?? 4 }}" class="group block w-full max-w-[270px] focus:outline-none" title="Lihat Profil {{ $kepalaLab?->name ?? 'Kepala Laboratorium' }}">
                                            <div class="rounded-sm sm:rounded-none p-[1px] bg-gradient-to-b from-amber-300 via-amber-100 to-amber-200 hover:from-amber-500 hover:to-orange-400 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                                <div class="bg-white rounded-sm sm:rounded-none p-4 text-center">
                                                    <div class="inline-block px-2.5 py-0.5 rounded-sm bg-gradient-to-r from-amber-600 to-amber-700 text-white text-[9px] font-black uppercase tracking-wider mb-2.5 shadow-xs">
                                                        KEPALA BENGKEL & LAB
                                                    </div>
                                                    ...
                                                    <div class="inline-block px-2.5 py-0.5 rounded-sm bg-amber-50 border border-amber-200 text-amber-800 font-bold text-[11px] uppercase tracking-wider mb-1">
                                                        Kepala Laboratorium
                                                    </div>
                                ...
                                <div class="flex justify-center items-center py-2 relative z-10">
                                    <div class="w-0.5 h-14 bg-slate-300 relative flex justify-center">
                                        <!-- Label pill on line -->
                                        <div class="absolute top-1/2 -translate-y-1/2 px-3 py-1 rounded-sm bg-white border border-slate-300 shadow-xs text-[10px] font-black uppercase tracking-wider text-slate-600 whitespace-nowrap z-20 flex items-center gap-1.5">
                                ...
                                <div class="org-tree-row max-w-[1060px] mx-auto z-10">
                                    ...
                                    <div class="org-tree-col w-1/4 px-2 sm:px-2.5">
                                        ...
                                        <a href="#guru-{{ $bidangPrestasi?->id ?? 5 }}" class="group block w-full focus:outline-none" title="Lihat Profil {{ $bidangPrestasi?->name ?? 'Bidang Event & Prestasi' }}">
                                            <div class="bg-white rounded-sm sm:rounded-none border-t-4 border-amber-500 border-x border-b border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 p-3.5 text-center">
                                                ...
                                                <div class="inline-block px-2 py-0.5 rounded-sm bg-amber-50 border border-amber-200 text-amber-800 font-bold text-[10px] uppercase tracking-wide">
                                    ...
                                    <div class="org-tree-col w-1/4 px-2 sm:px-2.5">
                                        ...
                                        <a href="#guru-{{ $bidangIduka?->id ?? 6 }}" class="group block w-full focus:outline-none" title="Lihat Profil {{ $bidangIduka?->name ?? 'Bidang IDUKA' }}">
                                            <div class="bg-white rounded-sm sm:rounded-none border-t-4 border-emerald-500 border-x border-b border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 p-3.5 text-center">
                                                <div class="w-16 h-16 rounded-full overflow-hidden mx-auto mb-2 border-2 border-white shadow ring-2 ring-slate-200 bg-slate-100">
                                                ...
                                                <div class="inline-block px-2 py-0.5 rounded-sm bg-emerald-50 border border-emerald-200 text-emerald-800 font-bold text-[10px] uppercase tracking-wide">
                                                    Bidang IDUKA
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <div class="org-tree-col w-1/4 px-2 sm:px-2.5">
                                        ...
                                        <a href="#guru-{{ $bidangPkl?->id ?? 7 }}" class="group block w-full focus:outline-none" title="Lihat Profil {{ $bidangPkl?->name ?? 'Bidang PKL' }}">
                                            <div class="bg-white rounded-sm sm:rounded-none border-t-4 border-blue-500 border-x border-b border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 p-3.5 text-center">
                                                <div class="w-16 h-16 rounded-full overflow-hidden mx-auto mb-2 border-2 border-white shadow ring-2 ring-slate-200 bg-slate-100">
                                                ...
                                                <div class="inline-block px-2 py-0.5 rounded-sm bg-blue-50 border border-blue-200 text-blue-800 font-bold text-[10px] uppercase tracking-wide">
                                                    Bidang PKL
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <div class="org-tree-col w-1/4 px-2 sm:px-2.5">
                                        ...
                                        <a href="#guru-{{ $toolman?->id ?? 8 }}" class="group block w-full focus:outline-none" title="Lihat Profil {{ $toolman?->name ?? 'Toolman' }}">
                                            <div class="bg-white rounded-sm sm:rounded-none border-t-4 border-slate-800 border-x border-b border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 p-3.5 text-center relative">
                                                <div class="w-16 h-16 rounded-full overflow-hidden mx-auto mb-2 border-2 border-white shadow ring-2 ring-slate-200 bg-slate-100">
                                                ...
                                                <div class="inline-block px-2 py-0.5 rounded-sm bg-slate-100 border border-slate-200 text-slate-800 font-bold text-[10px] uppercase tracking-wide">
                                                    Toolman / Teknisi Lab
                                                </div>
                                                <!-- Direct oversight indicator badge -->
                                                <div class="mt-1.5 text-[9px] font-semibold text-amber-700 bg-amber-50 rounded-sm px-1.5 py-0.5 border border-amber-200/60 inline-flex items-center gap-1">
                    ...
                    <div x-show="activeTab === 'cards'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" style="display: none;">
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
                            ...
                            <div class="bg-gradient-to-b from-red-50/50 to-white rounded-sm sm:rounded-none border border-red-200/80 p-6 shadow-sm flex flex-col justify-between">
                                <div>
                                    ...
                                    <div class="space-y-4">
                                        @foreach($clusterLeadership as $leader)
                                            <a href="#guru-{{ $leader->id }}" class="flex items-center gap-3.5 p-2.5 rounded-sm hover:bg-white hover:shadow-md border border-transparent hover:border-slate-200 transition-all duration-200 group">
                            ...
                            <div class="bg-gradient-to-b from-amber-50/50 to-white rounded-sm sm:rounded-none border border-amber-200/80 p-6 shadow-sm flex flex-col justify-between">
                                <div>
                                    <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <div class="space-y-4">
                                        @foreach($clusterLab as $labStaff)
                                            <a href="#guru-{{ $labStaff->id }}" class="flex items-center gap-3.5 p-2.5 rounded-sm hover:bg-white hover:shadow-md border border-transparent hover:border-slate-200 transition-all duration-200 group">
                            ...
                            <div class="bg-gradient-to-b from-slate-100/60 to-white rounded-sm sm:rounded-none border border-slate-300/80 p-6 shadow-sm flex flex-col justify-between">
                                <div>
                                    <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <div class="space-y-4">
                                        @foreach($clusterIndustry as $indStaff)
                                            <a href="#guru-{{ $indStaff->id }}" class="flex items-center gap-3.5 p-2.5 rounded-sm hover:bg-white hover:shadow-md border border-transparent hover:border-slate-200 transition-all duration-200 group">
                                                <div class="w-12 h-12 rounded-full overflow-hidden shrink-0 border-2 border-white shadow-sm ring-1 ring-slate-200">
                    ...
                    <div class="mt-12 rounded-sm sm:rounded-none bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white p-6 sm:p-8 border border-slate-800 shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6 z-10">
                        ...
                        <div class="flex items-center gap-4 relative z-10">
                            <div class="w-12 h-12 rounded-sm bg-red-600/20 border border-red-500/30 flex items-center justify-center shrink-0 text-red-500">
                        ...
                        <div class="flex items-center gap-3 relative z-10 shrink-0">
                            <a href="#direktori-guru" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-sm sm:rounded-[2px] bg-red-600 text-white font-heading font-bold text-xs uppercase tracking-wider hover:bg-red-700 shadow-md hover:shadow-lg transition-all duration-300">
        ...
        <x-frontend.layout.container class="px-4 sm:px-6 md:px-8">
            ...
            <div class="mb-10 sm:mb-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3.5 sm:gap-8">
                    @foreach($clusterLeadership as $leader)
                        <div id="guru-{{ $leader->id }}" class="scroll-mt-28 bg-slate-50/70 rounded-sm sm:rounded-none border border-slate-200 hover:border-red-300 hover:bg-white shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-row sm:flex-col group">
                            <!-- Photo Container -->
                            <div class="w-28 sm:w-full h-auto sm:h-72 min-h-[140px] bg-slate-200 overflow-hidden relative shrink-0">
                                ...
                                <div class="absolute bottom-2 left-2 right-2 sm:bottom-4 sm:left-4 sm:right-4">
                                    <span class="inline-block px-2 py-0.5 sm:px-3 sm:py-1 rounded-sm bg-red-600 text-white text-[9px] sm:text-[10px] font-black uppercase tracking-wider sm:tracking-widest shadow-sm truncate max-w-full">
                                ...
                                <div>
                                    ...
                                    @if($leader->specialization)
                                        <div class="mb-2 sm:mb-4">
                                            ...
                                            <div class="inline-flex items-center gap-1.5 text-[11px] sm:text-xs font-bold text-slate-800 bg-white px-2 py-1 sm:px-3 sm:py-1.5 rounded-sm border border-slate-200 shadow-2xs truncate max-w-full">
            ...
            <div class="mb-10 sm:mb-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-8 max-w-4xl">
                    @foreach($clusterLab as $labStaff)
                        <div id="guru-{{ $labStaff->id }}" class="scroll-mt-28 bg-slate-50/70 rounded-sm sm:rounded-none border border-slate-200 hover:border-amber-300 hover:bg-white shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-row sm:flex-row group">
                            <!-- Photo -->
                            <div class="w-28 sm:w-2/5 h-auto sm:h-auto min-h-[140px] bg-slate-200 overflow-hidden relative shrink-0">
                                ...
                                <div class="absolute bottom-2 left-2 sm:hidden">
                                    <span class="inline-block px-2 py-0.5 rounded-sm bg-amber-500 text-white text-[9px] font-black uppercase tracking-wider">
                                        {{ $labStaff->position }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="p-3.5 sm:p-6 flex flex-col justify-between flex-grow min-w-0">
                                <div>
                                    <span class="hidden sm:inline-block px-2.5 py-1 rounded-sm bg-amber-500 text-white text-[10px] font-black uppercase tracking-wider mb-2">
                                        {{ $labStaff->position }}
                                    </span>
            ...
            <div class="mb-10 sm:mb-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3.5 sm:gap-8">
                    @foreach($clusterIndustry as $industryStaff)
                        <div id="guru-{{ $industryStaff->id }}" class="scroll-mt-28 bg-slate-50/70 rounded-sm sm:rounded-none border border-slate-200 hover:border-red-300 hover:bg-white shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-row sm:flex-col group">
                            <!-- Photo Container -->
                            <div class="w-28 sm:w-full h-auto sm:h-72 min-h-[140px] bg-slate-200 overflow-hidden relative shrink-0">
                                ...
                                <div class="absolute bottom-2 left-2 right-2 sm:bottom-4 sm:left-4 sm:right-4">
                                    <span class="inline-block px-2 py-0.5 sm:px-3 sm:py-1 rounded-sm bg-slate-900 text-white text-[9px] sm:text-[10px] font-black uppercase tracking-wider sm:tracking-widest shadow-sm truncate max-w-full">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                        @foreach($otherTeachers as $ot)
                            <div class="bg-white rounded-sm sm:rounded-none border border-slate-200 p-3.5 sm:p-5 shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center">
    ...
    <section class="py-20 bg-slate-50 border-t border-slate-200">
        <x-frontend.layout.container>
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                <div class="lg:col-span-5">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-4">
                            <div class="w-8 h-8 rounded-sm bg-red-100 text-red-600 flex items-center justify-center shrink-0 mt-0.5 font-bold text-sm">✓</div>
                            <div>
                ...
                <div class="lg:col-span-7 bg-slate-900 p-8 sm:p-10 rounded-sm sm:rounded-none text-white relative overflow-hidden shadow-2xl">
                    <div class="absolute -right-10 -bottom-10 w-48 h-48 bg-red-600/20 rounded-full blur-2xl pointer-events-none"></div>
                    <div class="relative z-10">
                        <span class="inline-block px-3 py-1 rounded-sm bg-white/10 text-amber-400 text-[10px] font-black uppercase tracking-widest mb-4">
                            KOLABORASI INDUSTRI
                        </span>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="{{ route('academic.programs') }}" class="px-6 py-3 bg-red-600 text-white text-xs font-bold uppercase tracking-wider rounded-sm sm:rounded-[2px] hover:bg-red-700 transition-colors shadow-lg shadow-red-900/40">
                                Lihat Program Keahlian
                            </a>
                            <a href="{{ route('academic.facilities') }}" class="px-6 py-3 bg-white/10 border border-white/20 text-white text-xs font-bold uppercase tracking-wider rounded-sm sm:rounded-[2px] hover:bg-white/20 transition-colors">
