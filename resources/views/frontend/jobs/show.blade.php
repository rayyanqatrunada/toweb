...
>
    ...
    <div class="bg-charcoal-50 pt-10 pb-14 lg:pt-14 lg:pb-20 relative overflow-hidden border-b border-charcoal-200">
        ...
        <x-frontend.layout.container class="relative z-10 text-center max-w-4xl mx-auto reveal-on-scroll reveal-up">
            <div class="flex justify-center mb-6">
                <span class="inline-flex items-center px-4 py-1.5 rounded-sm text-xs font-black tracking-widest uppercase bg-amber-100 text-amber-700 border border-amber-200 shadow-sm">
                    Bursa Kerja Khusus
                </span>
            </div>
            ...
            <div class="flex flex-wrap items-center justify-center text-charcoal-600 text-sm gap-y-4 gap-x-6 mt-6 font-semibold">
                <span class="flex items-center bg-white px-4 py-2.5 rounded-sm border border-charcoal-200 shadow-sm">
    ...
    <article class="bg-white py-12 lg:py-20 min-h-[50vh] reveal-on-scroll reveal-up">
        <x-frontend.layout.container class="max-w-4xl">
            ...
            <div class="bg-white rounded-sm sm:rounded-none shadow-xl shadow-charcoal-900/5 border border-charcoal-100 overflow-hidden mb-12">
                <!-- Info Header -->
                <div class="bg-charcoal-50 p-6 sm:p-8 lg:p-10 border-b border-charcoal-100 relative overflow-hidden">
                    ...
                    <div class="flex flex-col sm:flex-row gap-6 lg:gap-8 items-center sm:items-start text-center sm:text-left">
                        @if($job->industryPartner && $job->industryPartner->logo)
                            <div class="w-24 h-24 sm:w-32 sm:h-32 bg-white rounded-sm border border-charcoal-200 flex items-center justify-center p-4 shadow-sm shrink-0 mt-2">
                        ...
                        <div class="flex-grow w-full">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                                <div class="bg-white p-4 rounded-sm border border-charcoal-100 text-center sm:text-left shadow-sm">
                                ...
                                <div class="bg-white p-4 rounded-sm border border-charcoal-100 text-center sm:text-left shadow-sm sm:col-span-2">
                                    <span class="flex items-center justify-center sm:justify-start text-[11px] text-charcoal-500 uppercase tracking-widest font-black mb-1.5">
                ...
                <div class="p-6 sm:p-8 lg:p-10 space-y-12">
                    ...
                    <div>
                        <h2 class="text-xl lg:text-2xl font-bold text-charcoal-900 mb-6 flex items-center">
                            <span class="w-8 h-8 rounded-sm bg-amber-100 text-amber-600 flex items-center justify-center mr-3 shadow-sm border border-amber-200 shrink-0">
                    ...
                    <div>
                        <h2 class="text-xl lg:text-2xl font-bold text-charcoal-900 mb-6 flex items-center">
                            <span class="w-8 h-8 rounded-sm bg-emerald-100 text-emerald-600 flex items-center justify-center mr-3 shadow-sm border border-emerald-200 shrink-0">
                    ...
                    <div>
                        <h2 class="text-xl lg:text-2xl font-bold text-charcoal-900 mb-6 flex items-center">
                            <span class="w-8 h-8 rounded-sm bg-blue-100 text-blue-600 flex items-center justify-center mr-3 shadow-sm border border-blue-200 shrink-0">
                    ...
                    <div class="bg-charcoal-900 border border-charcoal-800 p-8 lg:p-10 rounded-sm sm:rounded-none text-center sm:text-left relative overflow-hidden mt-8 shadow-xl shadow-charcoal-900/10">
                        <!-- BG Element -->
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 items-center sm:justify-start">
                                @if($job->application_url)
                                    <a href="{{ $job->application_url }}" target="_blank" class="w-full sm:w-auto inline-flex justify-center items-center px-6 py-3.5 bg-primary-600 text-white font-bold rounded-sm sm:rounded-[2px] hover:bg-primary-500 transition-colors shadow-lg shadow-primary-900/20 focus:ring-4 focus:ring-primary-500/50">
                                        Lamar via Website
                                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                                    </a>
                                @endif
                                @if($job->application_email)
                                    <a href="mailto:{{ $job->application_email }}" class="w-full sm:w-auto inline-flex justify-center items-center px-6 py-3.5 bg-white/10 text-white border border-white/20 font-bold rounded-sm sm:rounded-[2px] hover:bg-white/20 transition-colors focus:ring-4 focus:ring-white/10">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                                        Kirim Lamaran via Email
                                    </a>
                                @endif
                                @if(!$job->application_url && !$job->application_email)
                                    <div class="flex items-center p-4 bg-amber-500/10 border border-amber-500/20 rounded-sm text-amber-300 w-full sm:w-auto text-left">
