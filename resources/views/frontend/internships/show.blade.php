        ...
        <div class="bg-white rounded-lg shadow max-w-4xl mx-auto p-8">
            ...
            <div class="flex items-center text-sm text-gray-500 mb-6">
                ...
                @if($internship->industryPartner)
                    <a href="{{ route('partnership.show', $internship->industryPartner->slug) }}" class="text-blue-600 hover:underline">{{ $internship->industryPartner->name }}</a>
                @else
                    -
                @endif
            </div>
            ...
            <div class="mt-8 pt-4 border-t">
                <a href="{{ route('internships.index') }}" class="text-blue-600 hover:underline">&larr; Kembali ke Daftar PKL</a>
            </div>
        </div>
    </div>
</x-layouts.app>
