<x-layouts.app title="Beranda">
    ...
    <section class="py-10 bg-white border-y border-charcoal-100 overflow-hidden">
        <x-frontend.layout.container>
            <p class="text-center text-xs font-bold text-charcoal-400 uppercase tracking-widest mb-6">Telah dipercaya oleh {{ $partnerCount ?: 10 }}+ Mitra Industri Strategis</p>
        ...
        <x-frontend.layout.container>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-3xl border border-charcoal-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all reveal-on-scroll reveal-up delay-100">
                    ...
                    <a href="{{ route('academic.programs') }}" class="text-primary-600 font-bold text-sm flex items-center hover:text-primary-700">Pelajari Kurikulum <svg class="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
                </div>
                ...
                <div class="bg-white p-8 rounded-3xl border border-charcoal-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all reveal-on-scroll reveal-up delay-200">
                    ...
                    <a href="{{ route('academic.facilities') }}" class="text-primary-600 font-bold text-sm flex items-center hover:text-primary-700">Lihat Fasilitas <svg class="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
                </div>
                ...
                <div class="bg-white p-8 rounded-3xl border border-charcoal-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all reveal-on-scroll reveal-up delay-300">
                    ...
                    <a href="{{ route('jobs.index') }}" class="text-primary-600 font-bold text-sm flex items-center hover:text-primary-700">Info Lowongan <svg class="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
                </div>
            </div>
        </x-frontend.layout.container>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-charcoal-50 p-8 rounded-3xl border border-charcoal-100 flex flex-col reveal-on-scroll reveal-up delay-{{ $loop->iteration * 100 }}">
                    ...
                    <div class="flex items-center gap-4">
                        <img src="{{ $alumni->photo ? Storage::url($alumni->photo) : 'https://ui-avatars.com/api/?name='.urlencode($alumni->name).'&background=random' }}" alt="{{ $alumni->name }}" class="w-12 h-12 rounded-full object-cover">
                        <div>
                            <p class="font-bold text-charcoal-900">{{ $alumni->name }}</p>
                            <p class="text-xs text-charcoal-500 font-medium">{{ $alumni->current_job ?? 'Alumni' }} di {{ $alumni->current_company ?? 'Perusahaan Otomotif' }}</p>
                        </div>
                    </div>
                </div>
                @endforeach
