    ...
    <div class="bg-charcoal-50 pt-10 pb-14 lg:pt-14 lg:pb-20 relative overflow-hidden border-b border-charcoal-200">
        ...
        <x-frontend.layout.container class="relative z-10 text-center max-w-4xl mx-auto reveal-on-scroll reveal-up">
            <div class="flex justify-center mb-6">
                <span class="inline-flex items-center px-4 py-1.5 rounded-sm text-xs font-black tracking-widest uppercase bg-primary-100 text-primary-700 border border-primary-200">
                    AGENDA & PENGUMUMAN
                </span>
            </div>
            ...
            <div class="flex flex-wrap items-center justify-center text-charcoal-600 text-sm gap-y-4 gap-x-6 md:gap-x-8 mt-6">
                <div class="flex items-center font-bold bg-white px-4 py-2 rounded-sm border border-charcoal-200 shadow-sm">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($announcement->file_attachment)
                <div class="mt-16 pt-10 border-t-2 border-dashed border-charcoal-200">
                    <div class="bg-charcoal-50 border border-charcoal-200 rounded-sm sm:rounded-none p-6 lg:p-8 flex flex-col sm:flex-row items-center sm:items-start sm:justify-between gap-6">
                        <div class="flex items-start text-center sm:text-left">
                            <div class="w-12 h-12 bg-white rounded-sm flex items-center justify-center border border-charcoal-200 shadow-sm shrink-0 mr-0 sm:mr-5 mb-4 sm:mb-0 mx-auto sm:mx-0">
                        ...
                        <a href="{{ Storage::url($announcement->file_attachment) }}" target="_blank" class="shrink-0 inline-flex items-center px-6 py-3 bg-primary-600 text-white font-bold rounded-sm sm:rounded-[2px] hover:bg-primary-700 transition-colors shadow-sm focus:ring-4 focus:ring-primary-100 group w-full sm:w-auto justify-center">
