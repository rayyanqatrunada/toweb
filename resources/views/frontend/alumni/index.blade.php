<x-layouts.app title="Jejaring Alumni">
    ...
    <div class="bg-charcoal-50 py-16 lg:py-24 relative overflow-hidden border-b border-charcoal-200">
        ...
        <x-frontend.layout.container class="relative z-10 text-center max-w-3xl mx-auto reveal-on-scroll reveal-up">
            <x-frontend.ui.eyebrow class="text-primary-600 mb-4 justify-center">Alumni Network</x-frontend.ui.eyebrow>
        ...
        <x-frontend.layout.container>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @forelse($alumnis as $alumni)
                    <div class="bg-white rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 border border-charcoal-200 hover:border-primary-300 overflow-hidden group transition-all duration-300 relative flex flex-col h-full reveal-on-scroll reveal-up delay-{{ $loop->iteration * 100 % 300 }}">
