...
>
    ...
    <article class="bg-white py-12 lg:py-20 min-h-[50vh]">
        <x-frontend.layout.container class="max-w-5xl">
            ...
            <div class="bg-white rounded-sm sm:rounded-none shadow-xl shadow-charcoal-900/5 border border-charcoal-100 overflow-hidden mb-16 flex flex-col md:flex-row relative z-10 reveal-on-scroll reveal-up">
                <!-- Sidebar / Photo -->
                <div class="md:w-1/3 bg-charcoal-50 border-b md:border-b-0 md:border-r border-charcoal-200 flex flex-col items-center py-16 px-8 relative overflow-hidden">
                    ...
                    <div class="w-56 h-56 rounded-sm sm:rounded-none overflow-hidden shadow-2xl shadow-charcoal-900/10 border-4 border-white mb-8 relative z-10 bg-charcoal-100 flex-shrink-0">
                        @if($alumni->photo)
                ...
                <div class="md:w-2/3 p-8 md:p-12">
                    @if($alumni->current_occupation || $alumni->current_company)
                        <div class="bg-primary-50 rounded-sm sm:rounded-none p-8 mb-10 border border-primary-100 shadow-sm relative overflow-hidden group">
                    ...
                    @if($alumni->education)
                        <div class="mb-10">
                            <h3 class="text-xl font-bold text-charcoal-900 mb-5 flex items-center">
                                <div class="w-8 h-8 rounded-sm bg-charcoal-100 text-charcoal-600 flex items-center justify-center mr-3">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"></path></svg>
                                </div>
                                Riwayat Pendidikan
                            </h3>
                            <div class="prose prose-charcoal max-w-none bg-charcoal-50 p-6 rounded-sm sm:rounded-none border border-charcoal-100">
