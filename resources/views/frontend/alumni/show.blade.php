...
>
    ...
    <div class="bg-charcoal-950 py-16 lg:py-24 relative overflow-hidden">
        ...
        <x-frontend.layout.container class="relative z-10 text-center">
    ...
    <article class="bg-white py-16 lg:py-24 min-h-[50vh]">
        <x-frontend.layout.container class="max-w-5xl">
            ...
            <div class="text-center pt-8">
                <a href="{{ route('alumni.index') }}" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-bold text-charcoal-700 bg-white border-2 border-charcoal-200 rounded-xl hover:bg-charcoal-50 hover:text-primary-600 hover:border-primary-200 transition-all focus:ring-4 focus:ring-charcoal-100 group">
