    ...
    <div class="max-w-[1440px] mx-auto px-6 md:px-16 relative">
        <div class="flex justify-between items-center transition-all duration-300 h-[64px]">
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-6 flex-grow justify-end">
                ...
                <a href="{{ route('achievements.index') }}" class="relative group font-sans text-[14px] tracking-[-0.5px] uppercase transition-colors {{ request()->is('prestasi*') && !request()->is('berita*') ? 'text-figma-dark font-bold' : 'text-figma-gray hover:text-figma-dark' }}">
                    Prestasi
                    <span class="absolute -bottom-[22px] left-0 h-[3px] bg-figma-red transition-all duration-300 {{ request()->is('prestasi*') && !request()->is('berita*') ? 'w-full' : 'w-0 group-hover:w-full' }}"></span>
                </a>
                ...
                <a href="{{ route('news.index') }}" class="relative group font-sans text-[14px] tracking-[-0.5px] uppercase transition-colors {{ request()->is('berita*') || request()->is('pengumuman*') || request()->is('unduhan*') ? 'text-figma-dark font-bold' : 'text-figma-gray hover:text-figma-dark' }}">
                    Publikasi
                    <span class="absolute -bottom-[22px] left-0 h-[3px] bg-figma-red transition-all duration-300 {{ request()->is('berita*') || request()->is('pengumuman*') || request()->is('unduhan*') ? 'w-full' : 'w-0 group-hover:w-full' }}"></span>
                </a>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="flex flex-col py-3">
                ...
                <a href="{{ route('achievements.index') }}" class="px-6 py-3 font-sans text-[15px] font-medium {{ request()->is('prestasi*') ? 'text-figma-red bg-red-50' : 'text-figma-gray hover:bg-gray-50' }}">Prestasi</a>
                ...
                <a href="{{ route('news.index') }}" class="px-6 py-3 font-sans text-[15px] font-medium {{ request()->is('berita*') || request()->is('pengumuman*') || request()->is('unduhan*') ? 'text-figma-red bg-red-50' : 'text-figma-gray hover:bg-gray-50' }}">Publikasi</a>
