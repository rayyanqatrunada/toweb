<footer class="bg-slate-900 border-t border-slate-800">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-8 lg:py-12">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0 max-w-md">
              ...
              <p class="text-slate-400 text-sm leading-relaxed mb-4">
                Program Keahlian Teknik Otomotif berdedikasi untuk mencetak mekanik dan ahli otomotif masa depan yang kompeten, disiplin, dan siap kerja di dunia industri modern.
              </p>
          </div>
              ...
              <div>
                  ...
                  <ul class="text-slate-400 font-medium space-y-3 text-sm">
                      <li class="flex items-start">
                          <span class="mr-2">📍</span> Jl. Pendidikan No. 1, Kota Belajar
                      </li>
                      <li class="flex items-center">
                          <span class="mr-2">📞</span> (021) 123-4567
                      </li>
                      <li class="flex items-center">
                          <span class="mr-2">✉️</span> info@otomotif.sch.id
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-slate-500 sm:text-center">© {{ date('Y') }} <a href="/" class="hover:underline text-slate-400">Teknik Otomotif</a>. Hak Cipta Dilindungi.
          </span>
      </div>
    </div>
</footer>
