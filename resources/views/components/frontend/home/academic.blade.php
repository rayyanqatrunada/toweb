...
<section class="w-full py-24 lg:py-32 border-t border-gray-100 overflow-hidden relative">
    <div class="max-w-[1440px] mx-auto px-6 md:px-16">
        ...
        <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16 lg:mb-24 reveal-on-scroll reveal-up">
            ...
            <a href="{{ route('academic.programs') }}" class="group inline-flex items-center gap-4 text-figma-dark hover:text-figma-red transition-colors font-sans font-bold text-[16px] uppercase tracking-[-0.5px]">
                <span class="relative">
                                ...
                                <ul class="space-y-4">
                                    @foreach($program->competencies->take(5) as $competency)
                                        <li class="flex items-start gap-4">
                                            ...
                                            <span class="font-sans text-[15px] text-charcoal-700 leading-snug">{{ $competency->name }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            @endif
