            ...
            <div class="w-full lg:w-5/12 bg-charcoal-950 p-6 sm:p-8 md:p-12 text-white relative overflow-hidden group rounded-2xl shadow-xl flex flex-col justify-between">
                ...
                @if($headOfDepartment)
                    ...
                    <div class="flex flex-col h-full z-10 relative">
                        ...
                        <h4 class="font-heading font-bold text-[22px] sm:text-[28px] md:text-[32px] leading-tight mb-1 sm:mb-2 text-white text-center md:text-left">{{ $headOfDepartment->name }}</h4>
                        <p class="font-sans text-[13px] sm:text-[15px] font-medium text-figma-red mb-4 sm:mb-6 text-center md:text-left">{{ $headOfDepartment->position ?? 'Ketua Kompetensi Keahlian TBSM' }}</p>
