        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left flex flex-col justify-center">
                ...
                <x-frontend.hero.cta-group class="sm:justify-center lg:justify-start">
                    <a href="#about" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-semibold rounded-sm sm:rounded-[2px] text-white bg-red-600 hover:bg-red-700 md:text-lg transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5">
                        Jelajahi Jurusan
                    </a>
                    <a href="{{ route('academic.programs') ?? '/akademik/program' }}" class="inline-flex items-center justify-center px-6 py-3 border border-slate-300 text-base font-semibold rounded-sm sm:rounded-[2px] text-slate-700 bg-white hover:bg-slate-50 hover:text-slate-900 md:text-lg transition-all shadow-sm hover:shadow">
            ...
            <div class="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center reveal-on-scroll reveal-fade delay-200">
                <div class="relative mx-auto w-full rounded-sm sm:rounded-none shadow-2xl lg:max-w-md overflow-hidden bg-slate-200 aspect-[4/3] sm:aspect-square lg:aspect-[3/4]">
