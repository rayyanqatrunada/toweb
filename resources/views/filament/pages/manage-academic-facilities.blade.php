    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl bg-primary-50/60 border border-primary-100 dark:bg-primary-950/20 dark:border-primary-900/40">
            ...
            <div class="flex items-center gap-2 shrink-0">
                <a href="{{ route('academic.facilities') }}" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-300 dark:border-gray-700 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
        ...
        <div class="sticky bottom-4 z-20 flex flex-col sm:flex-row items-center justify-between gap-4 p-4 rounded-2xl bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border border-gray-200 dark:border-gray-800 shadow-xl">
            <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                ...
                <span>Tersedia 4 tab pengaturan fasilitas. Tekan simpan untuk menerapkan seluruh perubahan seketika.</span>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('academic.facilities') }}" target="_blank" class="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-gray-300 dark:border-gray-700 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                    <x-heroicon-m-arrow-top-right-on-square class="w-4 h-4 text-gray-500" />
                    <span>Lihat Halaman Publik</span>
                </a>
                <x-filament::button type="submit" icon="heroicon-m-check">
                    Simpan Pengaturan Fasilitas
                </x-filament::button>
            </div>
        </div>
    </form>
