    ...
    <div class="max-w-[1440px] mx-auto px-5 sm:px-8 md:px-16">
        ...
        <div class="flex flex-col lg:flex-row gap-10 sm:gap-16 lg:gap-24 items-center">
            ...
            <div class="w-full lg:w-1/2 reveal-on-scroll reveal-up">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($partner): ?>
                    ...
                    <div class="p-5 sm:p-8 border border-gray-200 bg-gray-50 flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 mb-6 sm:mb-8 group rounded-lg sm:rounded-none">
                        <div class="w-20 h-20 sm:w-28 sm:h-28 bg-white rounded-full flex items-center justify-center shadow-md p-3 sm:p-4 shrink-0 overflow-hidden group-hover:shadow-lg group-hover:scale-105 transition-all duration-300">
                            ...
                            <?php else: ?>
                                <div class="font-heading font-black text-3xl sm:text-4xl text-gray-300"><?php echo e(substr($partner->name, 0, 1)); ?></div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <div class="text-center sm:text-left">
                            <h3 class="font-heading font-bold text-[20px] sm:text-[24px] text-figma-dark mb-1.5 sm:mb-2"><?php echo e($partner->name); ?></h3>
                ...
                <a href="<?php echo e(route('partnership.index')); ?>" class="inline-flex items-center justify-center px-6 sm:px-8 py-3.5 sm:py-4 bg-figma-dark text-white font-sans font-bold text-[13px] sm:text-[14px] uppercase tracking-wide hover:bg-figma-red transition-colors focus-ring w-full sm:w-auto rounded-sm">
            ...
            <div class="w-full lg:w-1/2 relative reveal-on-scroll reveal-up delay-200">
                <!-- Decorative background block (Hidden on mobile to avoid overflow) -->
