...
>
    ...
    >
        ...
        <div class="mx-auto max-w-3xl transform divide-y divide-slate-100 overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/5 transition-all" @click.outside="isSearchOpen = false">
            ...
            <!-- Area Input Form -->
            <form action="<?php echo e(route('search') ?? '/search'); ?>" method="GET" class="relative">
...
<?php /**PATH /home/Rayy/Project/Github/TBSM WEB/toweb/resources/views/components/global-search-modal.blade.php ENDPATH**/ ?>