...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <section class="relative bg-charcoal-50 overflow-hidden border-b border-charcoal-200 pt-8 pb-12 sm:pt-10 sm:pb-16 lg:pt-14 lg:pb-24">
        <!-- Background -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->get('header_about_image')): ?>
            <img src="<?php echo e(Storage::url($settings->get('header_about_image'))); ?>" alt="About Background" class="absolute inset-0 z-0 w-full h-full object-cover opacity-15 pointer-events-none">
        <?php else: ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                ...
                <div class="lg:col-span-8 reveal-on-scroll reveal-up">
                    ...
                    <div class="prose prose-lg prose-charcoal prose-p:leading-relaxed prose-a:text-primary-600 hover:prose-a:text-primary-700 max-w-none">
                        <?php echo \App\Support\HtmlSanitizer::clean($settings->get('profile_history', '<p>Sejarah singkat jurusan ' . $settings->get('site_name', 'Teknik Sepeda Motor') . ' (' . $settings->get('site_short_name', 'TSM') . ') bermula dari dedikasi kami untuk mencetak tenaga kerja profesional. Dengan fasilitas yang terus berkembang, kami selalu berusaha menyesuaikan kurikulum dengan teknologi terkini di dunia otomotif.</p>')); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                ...
                <div class="lg:col-span-5 relative reveal-on-scroll reveal-left">
                    <div class="aspect-[4/5] relative rounded-3xl overflow-hidden bg-charcoal-100 shadow-xl flex items-center justify-center">
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasAboutHeadPhoto && $aboutHeadPhotoUrl): ?>
                            <img src="<?php echo e($aboutHeadPhotoUrl); ?>" alt="<?php echo e($headOfDepartment->name); ?>" class="absolute inset-0 w-full h-full object-cover object-top" loading="lazy">
                        <?php else: ?>
                            <div class="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-charcoal-800 to-charcoal-950 text-white p-8 text-center">
                                <div class="w-24 h-24 rounded-full bg-white/10 flex items-center justify-center font-heading font-black text-3xl mb-4 border border-white/20">
                                    <?php echo e(isset($headOfDepartment) ? strtoupper(substr(trim(preg_replace('/^(Drs\.|Dr\.|Ir\.|H\.|Hj\.)\s+/i', '', $headOfDepartment->name)), 0, 2)) : 'KJ'); ?>

                                </div>
                                <h4 class="font-heading font-bold text-xl"><?php echo e(isset($headOfDepartment) ? $headOfDepartment->name : 'Ketua Kompetensi Keahlian'); ?></h4>
                                <p class="text-charcoal-400 text-xs mt-1"><?php echo e($settings->get('site_short_name', 'TSM')); ?> SMKN 1 Bangsri</p>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <!-- Bottom Gradient -->
                ...
                <div class="lg:col-span-7 flex flex-col justify-center reveal-on-scroll reveal-up">
                    ...
                    <p class="text-base sm:text-xl lg:text-2xl font-bold text-charcoal-900 leading-relaxed italic mb-6 sm:mb-8">
                        "<?php echo \App\Support\HtmlSanitizer::clean($aboutHeadQuote); ?>"
                    </p>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-bold text-primary-600 mt-1"><?php echo e(isset($headOfDepartment) && $headOfDepartment->position ? $headOfDepartment->position : 'Kepala Program Keahlian Otomotif'); ?></p>
                    </div>
                </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-12 reveal-on-scroll reveal-up">
                ...
                <div class="mt-6 md:mt-0">
                    <?php if (isset($component)) { $__componentOriginal4790532a04fde6528e82c3998ebdc4a7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4790532a04fde6528e82c3998ebdc4a7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.ui.button','data' => ['href' => ''.e(route('academic.facilities')).'','variant' => 'outline-dark']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('frontend.ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('academic.facilities')).'','variant' => 'outline-dark']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH /home/Rayy/Project/Github/TBSM WEB/toweb/resources/views/frontend/about.blade.php ENDPATH**/ ?>