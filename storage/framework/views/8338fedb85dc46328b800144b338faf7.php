...
<section class="w-full py-12 sm:py-16 md:py-24 lg:py-32 border-t border-gray-100 overflow-hidden relative">
    <div class="max-w-[1440px] mx-auto px-5 sm:px-8 md:px-16">
        ...
        <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-6 sm:gap-8 mb-10 sm:mb-16 lg:mb-24 reveal-on-scroll reveal-up">
            ...
            <a href="<?php echo e(route('academic.programs')); ?>" class="group inline-flex items-center gap-3 sm:gap-4 text-figma-dark hover:text-figma-red transition-colors font-sans font-bold text-[14px] sm:text-[16px] uppercase tracking-[-0.5px]">
                <span class="relative">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="lg:col-span-12 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center reveal-on-scroll reveal-up delay-100">
                        ...
                        <div class="order-2 <?php echo e($index % 2 == 0 ? 'md:order-1' : 'md:order-2 lg:pl-16'); ?>">
                            <div class="text-figma-red/20 font-heading font-black text-[36px] sm:text-[48px] md:text-[64px] leading-none mb-1 sm:mb-2"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></div>
                            <h3 class="font-heading font-bold text-[22px] sm:text-[30px] md:text-[40px] text-figma-dark mb-3 sm:mb-4 leading-[1.15] sm:leading-[1.1]"><?php echo e($program->name); ?></h3>
                            <div class="font-sans text-[14px] sm:text-[16px] text-gray-600 leading-[1.65] sm:leading-[1.7] mb-6 sm:mb-8 [&>p]:mb-3 [&>h4]:font-heading [&>h4]:font-bold [&>h4]:text-figma-dark [&>h4]:text-[16px] sm:[&>h4]:text-[18px] [&>h4]:mb-2 [&>ul]:list-disc [&>ul]:pl-5 [&>ul>li]:mb-1">
                                <?php echo \App\Support\HtmlSanitizer::clean($program->description ?? 'Program ini membekali siswa dengan keterampilan teknis otomotif terkini yang disesuaikan dengan standar kebutuhan industri.'); ?>
                                ...
                                <ul class="space-y-3 sm:space-y-4">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $program->competencies->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $competency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <li class="flex items-start gap-3 sm:gap-4">
                                            ...
                                            <span class="font-sans text-[14px] sm:text-[15px] text-charcoal-700 leading-snug"><?php echo e($competency->name); ?></span>
                                        </li>
                        ...
                        <!-- Image Block -->
                        <div class="order-1 <?php echo e($index % 2 == 0 ? 'md:order-2' : 'md:order-1'); ?> relative w-full aspect-[16/10] sm:aspect-square md:aspect-[4/5] bg-gray-100 group overflow-hidden border border-gray-200 rounded-lg sm:rounded-none">
                            <img src="<?php echo e($program->thumbnail ? Storage::url($program->thumbnail) : 'https://images.unsplash.com/photo-1610491462702-42e6ecd6a982?q=80&w=800&auto=format&fit=crop'); ?>" 
...
<?php /**PATH /home/Rayy/Project/Github/TBSM WEB/toweb/resources/views/components/frontend/home/academic.blade.php ENDPATH**/ ?>