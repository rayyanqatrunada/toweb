...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <h1 class="text-3xl md:text-5xl lg:text-6xl font-extrabold text-charcoal-900 mb-8 leading-[1.15] tracking-tight"><?php echo e($internship->title); ?></h1>
            ...
            <div class="flex flex-wrap items-center justify-center text-charcoal-600 text-sm gap-4 font-semibold">
                <span class="flex items-center bg-white px-5 py-2.5 rounded-xl border border-charcoal-200 shadow-sm">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($internship->industryPartner): ?>
                        <a href="<?php echo e(route('partnership.show', $internship->industryPartner->slug)); ?>" class="text-primary-600 hover:text-primary-700 transition-colors"><?php echo e($internship->industryPartner->name); ?></a>
                    <?php else: ?>
                        -
...
<?php endif; ?>
<?php /**PATH /home/Rayy/Project/Github/TBSM WEB/toweb/resources/views/frontend/internships/show.blade.php ENDPATH**/ ?>