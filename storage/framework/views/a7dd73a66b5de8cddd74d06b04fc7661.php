...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Pengumuman']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Pengumuman']); ?>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="space-y-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('announcements.show', $announcement->slug)); ?>" class="flex flex-col sm:flex-row bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group focus-visible:ring-4 focus-visible:ring-red-500 focus:outline-none hover:-translate-y-1">
                        <div class="bg-red-50 text-red-700 px-6 py-4 flex flex-col items-center justify-center border-b sm:border-b-0 sm:border-r border-slate-100 min-w-[120px]">
                            <span class="text-sm font-bold uppercase tracking-widest"><?php echo e($announcement->created_at->translatedFormat('M')); ?></span>
                            <span class="text-4xl font-extrabold leading-none my-1"><?php echo e($announcement->created_at->format('d')); ?></span>
                            <span class="text-xs font-semibold text-red-500"><?php echo e($announcement->created_at->format('Y')); ?></span>
                        </div>
                        <div class="p-6 flex-1 flex flex-col justify-center">
                            ...
                            <div class="flex items-center text-xs text-slate-500 mt-auto">
                                <span class="flex items-center bg-slate-100 px-3 py-1 rounded-full">
                                    ...
                                    Diumumkan <?php echo e($announcement->created_at->diffForHumans()); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Belum Ada Pengumuman','message' => 'Pengumuman atau agenda belum tersedia saat ini.','icon' => 'calendar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Pengumuman','message' => 'Pengumuman atau agenda belum tersedia saat ini.','icon' => 'calendar']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
