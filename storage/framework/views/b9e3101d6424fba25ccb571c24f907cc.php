...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Struktur Organisasi & Dewan Guru '.e($settings->get('site_short_name', 'TSM')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Struktur Organisasi & Dewan Guru '.e($settings->get('site_short_name', 'TSM')).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "WebPage",
      "name": "Struktur Organisasi & Dewan Guru <?php echo e($settings->get('site_short_name', 'TSM')); ?> SMK Negeri 1 Bangsri",
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.layout.container','data' => ['class' => 'relative z-10 px-4 sm:px-6 md:px-8']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'relative z-10 px-4 sm:px-6 md:px-8']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="max-w-4xl">
                ...
                <h1 class="text-2xl sm:text-5xl lg:text-6xl font-heading font-black tracking-tight leading-[1.1] sm:leading-[1.08] uppercase text-slate-900 mb-4 sm:mb-6 reveal-on-scroll reveal-up delay-100">
                    ...
                    <span class="bg-gradient-to-r from-red-600 via-rose-600 to-amber-600 bg-clip-text text-transparent">Dewan Guru <?php echo e($settings->get('site_short_name', 'TSM')); ?></span>
                </h1>
            ...
            <div class="mt-8 sm:mt-14 pt-6 sm:pt-8 border-t border-slate-200/80 grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-6 reveal-on-scroll reveal-up delay-300">
                <div class="flex items-center gap-3 sm:gap-3.5">
                    ...
                    <div>
                        ...
                        <div class="text-[11px] sm:text-xs text-slate-500">Keluarga Besar <?php echo e($settings->get('site_short_name', 'TSM')); ?></div>
                    </div>
                </div>
            ...
            <div class="flex flex-col lg:flex-row lg:items-end justify-between mb-8 sm:mb-10 gap-6 reveal-on-scroll reveal-up">
                <div class="max-w-2xl">
                    ...
                    <p class="text-slate-600 text-xs sm:text-base mt-2 leading-relaxed">
                        Diagram hierarki kepemimpinan kejuruan, manajerial fasilitas bengkel berstandar AHASS, serta koordinator operasional <?php echo e($settings->get('site_short_name', 'TSM')); ?> SMK Negeri 1 Bangsri.
                    </p>
                </div>
                        ...
                        <div class="overflow-x-auto pb-8 pt-2 -mx-2 px-2 scrollbar-thin">
                            <div class="min-w-[1020px] max-w-[1100px] mx-auto flex flex-col items-center relative z-10">
                                ...
                                <div class="flex flex-col items-center relative z-20">
                                    <a href="#guru-<?php echo e($hod?->id ?? 1); ?>" class="group block focus:outline-none" title="Lihat Profil <?php echo e($hod?->name ?? 'Pimpinan Kejuruan'); ?>">
                                        <div class="w-80 sm:w-[340px] rounded-2xl p-[1.5px] bg-gradient-to-b from-red-600 via-rose-500 to-amber-500 shadow-xl shadow-red-600/10 hover:shadow-2xl hover:shadow-red-600/20 hover:-translate-y-1.5 transition-all duration-500">
                                            <div class="bg-white rounded-[calc(1rem-1.5px)] p-5 text-center relative overflow-hidden">
                                                ...
                                                <div class="w-24 h-24 sm:w-26 sm:h-26 rounded-full overflow-hidden mx-auto mb-3 border-4 border-white shadow-lg ring-3 ring-amber-400 bg-slate-100 relative group-hover:ring-red-600 transition-all duration-300">
                                                    ...
                                                    <?php else: ?>
                                                        <div class="w-full h-full flex items-center justify-center bg-slate-900 text-amber-400 font-heading font-black text-2xl">
                                                            <?php echo e(strtoupper(substr(trim(preg_replace('/^(Drs\.|Dr\.|Ir\.|H\.|Hj\.)\s+/i', '', $hod?->name ?? 'PK')), 0, 2))); ?>
                                                ...
                                                <h3 class="font-heading font-black text-base sm:text-lg text-slate-900 leading-tight group-hover:text-red-600 transition-colors uppercase mb-1.5">
                                                    <?php echo e($hod?->name ?? 'Pimpinan Kejuruan'); ?>
                                ...
                                <div class="org-tree-row max-w-[940px] mx-auto z-10">
                                    ...
                                    <div class="org-tree-col w-1/3 px-3">
                                        ...
                                        <a href="#guru-<?php echo e($bendahara?->id ?? 2); ?>" class="group block w-full max-w-[270px] focus:outline-none" title="Lihat Profil <?php echo e($bendahara?->name ?? 'Bendahara'); ?>">
                                    ...
                                    <div class="org-tree-col w-1/3 px-3">
                                        ...
                                        <a href="#guru-<?php echo e($sekretaris?->id ?? 3); ?>" class="group block w-full max-w-[270px] focus:outline-none" title="Lihat Profil <?php echo e($sekretaris?->name ?? 'Sekretaris'); ?>">
                                    ...
                                    <div class="org-tree-col w-1/3 px-3">
                                        ...
                                        <a href="#guru-<?php echo e($kepalaLab?->id ?? 4); ?>" class="group block w-full max-w-[270px] focus:outline-none" title="Lihat Profil <?php echo e($kepalaLab?->name ?? 'Kepala Laboratorium'); ?>">
                                ...
                                <div class="org-tree-row max-w-[1060px] mx-auto z-10">
                                    ...
                                    <div class="org-tree-col w-1/4 px-2 sm:px-2.5">
                                        <div class="tree-node-dot !border-amber-500"></div>
                                        <a href="#guru-<?php echo e($bidangPrestasi?->id ?? 5); ?>" class="group block w-full focus:outline-none" title="Lihat Profil <?php echo e($bidangPrestasi?->name ?? 'Bidang Event & Prestasi'); ?>">
                                    ...
                                    <div class="org-tree-col w-1/4 px-2 sm:px-2.5">
                                        ...
                                        <a href="#guru-<?php echo e($bidangIduka?->id ?? 6); ?>" class="group block w-full focus:outline-none" title="Lihat Profil <?php echo e($bidangIduka?->name ?? 'Bidang IDUKA'); ?>">
                                    ...
                                    <div class="org-tree-col w-1/4 px-2 sm:px-2.5">
                                        ...
                                        <a href="#guru-<?php echo e($bidangPkl?->id ?? 7); ?>" class="group block w-full focus:outline-none" title="Lihat Profil <?php echo e($bidangPkl?->name ?? 'Bidang PKL'); ?>">
                                    ...
                                    <div class="org-tree-col w-1/4 px-2 sm:px-2.5">
                                        ...
                                        <a href="#guru-<?php echo e($toolman?->id ?? 8); ?>" class="group block w-full focus:outline-none" title="Lihat Profil <?php echo e($toolman?->name ?? 'Toolman'); ?>">
                        ...
                        <div class="flex items-center gap-4 relative z-10">
                            ...
                            <div>
                                <div class="font-heading font-black text-sm sm:text-base uppercase tracking-wider text-white">
                                    Struktur Resmi Tata Kelola Kejuruan <?php echo e($settings->get('site_short_name', 'TSM')); ?>
...
<?php endif; ?>
    ...
    <section id="direktori-guru" class="py-12 sm:py-20 lg:py-32 bg-white">
        <?php if (isset($component)) { $__componentOriginal264d3cdba9db237c49d9665edc40da42 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal264d3cdba9db237c49d9665edc40da42 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.layout.container','data' => ['class' => 'px-4 sm:px-6 md:px-8']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('frontend.layout.container'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'px-4 sm:px-6 md:px-8']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="mb-10 sm:mb-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3.5 sm:gap-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $clusterLeadership; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leader): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div id="guru-<?php echo e($leader->id); ?>" class="scroll-mt-28 bg-slate-50/70 rounded-2xl border border-slate-200 hover:border-red-300 hover:bg-white shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-row sm:flex-col group">
                            <!-- Photo Container -->
                            ...
                            <div class="p-3.5 sm:p-6 flex flex-col flex-grow justify-between min-w-0">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($leader->specialization): ?>
                                        <div class="mb-2 sm:mb-4">
                                            ...
                                            <div class="inline-flex items-center gap-1.5 text-[11px] sm:text-xs font-bold text-slate-800 bg-white px-2 py-1 sm:px-3 sm:py-1.5 rounded-lg border border-slate-200 shadow-2xs truncate max-w-full">
                                                ...
                                                <span class="truncate"><?php echo e($leader->specialization); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($leader->phone): ?>
                                    <div class="mt-2.5 sm:mt-6 pt-2 sm:pt-4 border-t border-slate-200 flex justify-end">
                                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $leader->phone)); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-1 sm:gap-1.5 text-[11px] sm:text-xs font-bold text-emerald-600 hover:text-emerald-700 transition-colors active:scale-95">
            ...
            <div class="mb-10 sm:mb-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-8 max-w-4xl">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $clusterLab; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $labStaff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div id="guru-<?php echo e($labStaff->id); ?>" class="scroll-mt-28 bg-slate-50/70 rounded-2xl border border-slate-200 hover:border-amber-300 hover:bg-white shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-row sm:flex-row group">
                            <!-- Photo -->
                                ...
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($labStaff->specialization): ?>
                                        <div class="mb-2 sm:mb-3">
                                            ...
                                            <p class="text-[11px] sm:text-xs font-bold text-slate-800 truncate"><?php echo e($labStaff->specialization); ?></p>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-10 sm:mb-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3.5 sm:gap-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $clusterIndustry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industryStaff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div id="guru-<?php echo e($industryStaff->id); ?>" class="scroll-mt-28 bg-slate-50/70 rounded-2xl border border-slate-200 hover:border-red-300 hover:bg-white shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-row sm:flex-col group">
                            <!-- Photo Container -->
                            <div class="w-28 sm:w-full h-auto sm:h-72 min-h-[140px] bg-slate-200 overflow-hidden relative shrink-0">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($industryStaff->specialization): ?>
                                        <div class="mb-2 sm:mb-4">
                                            ...
                                            <div class="inline-flex items-center gap-1.5 text-[11px] sm:text-xs font-bold text-slate-800 bg-white px-2 py-1 sm:px-3 sm:py-1.5 rounded-lg border border-slate-200 shadow-2xs truncate max-w-full">
                                                ...
                                                <span class="truncate"><?php echo e($industryStaff->specialization); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $otherTeachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="bg-white rounded-2xl border border-slate-200 p-3.5 sm:p-5 shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center">
                                ...
                                <h4 class="font-heading font-bold text-xs sm:text-base text-slate-900 mb-0.5 sm:mb-1 line-clamp-2"><?php echo e($ot->name); ?></h4>
                                <p class="text-[11px] sm:text-xs text-red-600 font-semibold mb-1 sm:mb-2"><?php echo e($ot->position ?? 'Guru Kejuruan'); ?></p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                <div class="lg:col-span-5">
                    ...
                    <p class="text-slate-600 text-base leading-relaxed mb-8">
                        Guru kejuruan <?php echo e($settings->get('site_short_name', 'TSM')); ?> SMK Negeri 1 Bangsri wajib mengikuti sertifikasi berjenjang dari PT Astra Honda Motor dan LSP Pihak Pertama guna menjamin kurikulum yang diajarkan selalu relevan dengan dinamika teknologi terkini.
                    </p>
                    <div class="space-y-4">
