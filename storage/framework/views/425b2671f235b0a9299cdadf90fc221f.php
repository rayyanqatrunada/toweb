            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $achievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $achievement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="bg-white rounded-lg shadow overflow-hidden flex flex-col">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($achievement->photo): ?>
                        <img src="<?php echo e(Storage::url($achievement->photo)); ?>" alt="<?php echo e($achievement->title); ?>" class="w-full h-48 object-cover">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <h2 class="text-xl font-bold mb-2">
                            <a href="<?php echo e(route('achievements.show', $achievement->slug)); ?>" class="hover:text-red-600"><?php echo e($achievement->title); ?></a>
                        </h2>
                        <p class="text-sm text-gray-500 mb-4"><?php echo e($achievement->date ? $achievement->date->format('d M Y') : ''); ?> | <?php echo e($achievement->organizer); ?></p>
                        
                        <div class="mt-auto">
                            <span class="inline-block bg-yellow-100 text-yellow-800 rounded-full px-3 py-1 text-sm font-semibold">
                                Peringkat: <?php echo e($achievement->rank); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Belum Ada Prestasi','message' => 'Data prestasi belum ditambahkan.','icon' => 'document']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Prestasi','message' => 'Data prestasi belum ditambahkan.','icon' => 'document']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
