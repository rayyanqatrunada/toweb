...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => '404 - Halaman Tidak Ditemukan','robots' => 'noindex, nofollow']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => '404 - Halaman Tidak Ditemukan','robots' => 'noindex, nofollow']); ?>
    ...
    <div class="min-h-[70vh] flex items-center justify-center py-16 sm:py-24 px-4 sm:px-6 relative overflow-hidden bg-[#FAFAFA]">
        ...
        <div class="max-w-xl mx-auto text-center relative z-10 reveal-on-scroll reveal-up">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                <a href="<?php echo e(route('home')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-figma-red hover:bg-figma-dark-red text-white font-sans font-bold text-[14px] uppercase tracking-wider rounded-xl transition-all shadow-md shadow-figma-red/20 active:scale-[0.98]">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    <span>Kembali ke Beranda</span>
                </a>
                <a href="<?php echo e(route('contact.index')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-white hover:bg-gray-50 text-figma-dark border border-[#E4E1E5] font-sans font-bold text-[14px] uppercase tracking-wider rounded-xl transition-all shadow-sm active:scale-[0.98]">
...
<?php endif; ?>
<?php /**PATH /home/Rayy/Project/Github/TBSM WEB/toweb/resources/views/errors/404.blade.php ENDPATH**/ ?>