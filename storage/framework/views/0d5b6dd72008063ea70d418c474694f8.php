...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => $announcement->title,'description' => Str::limit(strip_tags($announcement->content), 150),'canonical' => route('announcements.show', $announcement->slug)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($announcement->title),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(Str::limit(strip_tags($announcement->content), 150)),'canonical' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('announcements.show', $announcement->slug))]); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="flex justify-center mb-6">
                <span class="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-black tracking-widest uppercase bg-primary-500/20 text-primary-300 border border-primary-500/30">
                    AGENDA & PENGUMUMAN
                </span>
            </div>
            
            <h1 class="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white mb-8 leading-[1.15] tracking-tight"><?php echo e($announcement->title); ?></h1>
            
            <div class="flex flex-wrap items-center justify-center text-charcoal-300 text-sm gap-y-4 gap-x-6 md:gap-x-8 mt-6">
                <div class="flex items-center font-medium bg-charcoal-900/60 px-4 py-2 rounded-xl border border-charcoal-800">
                    <svg class="w-5 h-5 mr-2 opacity-70 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                ...
                <div class="flex items-center font-medium bg-charcoal-900/60 px-4 py-2 rounded-xl border border-charcoal-800">
                    ...
                    <?php echo e($announcement->created_at->translatedFormat('d F Y - H:i')); ?>
    ...
    <article class="bg-white py-12 lg:py-20 min-h-[50vh]">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="prose prose-lg md:prose-xl prose-slate max-w-none prose-headings:font-extrabold prose-headings:tracking-tight prose-headings:text-charcoal-900 prose-p:text-charcoal-700 prose-p:leading-relaxed prose-a:text-primary-600 hover:prose-a:text-primary-700 prose-img:rounded-2xl prose-img:shadow-md">
                <?php echo \App\Support\HtmlSanitizer::clean($announcement->content); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($announcement->file_attachment): ?>
                <div class="mt-16 pt-10 border-t-2 border-dashed border-charcoal-200">
                    <div class="bg-charcoal-50 border border-charcoal-200 rounded-2xl p-6 lg:p-8 flex flex-col sm:flex-row items-center sm:items-start sm:justify-between gap-6">
                        ...
                        <a href="<?php echo e(Storage::url($announcement->file_attachment)); ?>" target="_blank" class="shrink-0 inline-flex items-center px-6 py-3 bg-primary-600 text-white font-bold rounded-xl hover:bg-primary-700 transition-colors shadow-sm focus:ring-4 focus:ring-primary-100 group w-full sm:w-auto justify-center">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.ui.button','data' => ['href' => ''.e(route('announcements.index')).'','variant' => 'outline','class' => 'group']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('announcements.index')).'','variant' => 'outline','class' => 'group']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH D:\Project\test\Web Jurusan\TOWEB\resources\views/frontend/announcements/show.blade.php ENDPATH**/ ?>