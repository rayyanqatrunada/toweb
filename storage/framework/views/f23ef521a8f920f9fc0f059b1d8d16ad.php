...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <section class="bg-charcoal-50 border-b border-charcoal-200 relative overflow-hidden pt-10 pb-16 lg:pt-14 lg:pb-24">
        <!-- Background -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->get('header_news_image')): ?>
            <img src="<?php echo e(Storage::url($settings->get('header_news_image'))); ?>" alt="News Background" class="absolute inset-0 z-0 w-full h-full object-cover opacity-15 pointer-events-none">
        <?php else: ?>
...
<?php /**PATH /home/Rayy/Project/Github/TBSM WEB/toweb/resources/views/frontend/news/index.blade.php ENDPATH**/ ?>