    ...
    <div class="max-w-[1440px] mx-auto px-5 sm:px-8 md:px-16">
        <div class="flex flex-col lg:flex-row items-center gap-10 sm:gap-16 lg:gap-24">
            ...
            <div class="w-full lg:w-5/12 flex flex-col items-start z-10 reveal-on-scroll reveal-up">
                ...
                <!-- CTA -->
                <a href="<?php echo e(route('about')); ?>" class="group flex items-center gap-3 sm:gap-4 text-figma-dark hover:text-figma-red transition-colors font-sans font-bold text-[14px] sm:text-[16px] uppercase tracking-[-0.5px]">
                    <span class="relative">
