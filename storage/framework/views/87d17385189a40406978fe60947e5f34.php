    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-8 md:px-16">
        <div class="flex flex-col lg:flex-row items-center gap-6 sm:gap-16 lg:gap-24">
            ...
            <div class="w-full lg:w-5/12 flex flex-col items-start z-10 reveal-on-scroll reveal-up">
                ...
                <!-- CTA -->
                <a href="<?php echo e(route('about')); ?>" class="group flex items-center gap-2.5 sm:gap-4 text-figma-dark hover:text-figma-red transition-colors font-sans font-bold text-[13px] sm:text-[16px] uppercase tracking-tight">
                    <span class="relative">
...
<?php /**PATH /home/Rayy/Project/Github/TBSM WEB/toweb/resources/views/components/frontend/home/intro.blade.php ENDPATH**/ ?>