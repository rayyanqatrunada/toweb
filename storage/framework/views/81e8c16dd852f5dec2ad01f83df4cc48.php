...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => $alumni->name . ' - Profil Alumni','description' => $alumni->bio ? Str::limit(strip_tags($alumni->bio), 150) : 'Profil lulusan Teknik Otomotif angkatan ' . $alumni->graduation_year]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($alumni->name . ' - Profil Alumni'),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($alumni->bio ? Str::limit(strip_tags($alumni->bio), 150) : 'Profil lulusan Teknik Otomotif angkatan ' . $alumni->graduation_year)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.layout.container','data' => ['class' => 'relative z-10 text-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'relative z-10 text-center']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-6 leading-tight"><?php echo e($alumni->name); ?></h1>
...
<?php endif; ?>
    ...
    <div class="md:hidden">
        <?php if (isset($component)) { $__componentOriginal98ae32034a5e9865062f4201185788de = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal98ae32034a5e9865062f4201185788de = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.breadcrumbs','data' => ['items' => ['Kembali' => route('alumni.index')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('frontend.breadcrumbs'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Kembali' => route('alumni.index')])]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    ...
    <article class="bg-white py-16 lg:py-24 min-h-[50vh]">
        <?php if (isset($component)) { $__componentOriginal264d3cdba9db237c49d9665edc40da42 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal264d3cdba9db237c49d9665edc40da42 = $attributes; } ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-charcoal-900/5 border border-charcoal-100 overflow-hidden mb-16 flex flex-col md:flex-row relative z-10">
                <!-- Sidebar / Photo -->
                <div class="md:w-1/3 bg-charcoal-50 border-b md:border-b-0 md:border-r border-charcoal-200 flex flex-col items-center py-16 px-8 relative overflow-hidden">
                    ...
                    <h2 class="text-2xl font-black text-center text-charcoal-900 mb-2 relative z-10 leading-tight"><?php echo e($alumni->name); ?></h2>
                    <p class="text-primary-600 font-bold text-sm mb-8 uppercase tracking-widest text-center relative z-10">Angkatan <?php echo e($alumni->graduation_year); ?></p>
                </div>
                
                <!-- Main Content -->
                <div class="md:w-2/3 p-8 md:p-12">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alumni->current_occupation || $alumni->current_company): ?>
                        <div class="bg-primary-50 rounded-2xl p-8 mb-10 border border-primary-100 shadow-sm relative overflow-hidden group">
                            ...
                            <p class="text-2xl relative z-10 leading-tight">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alumni->current_occupation): ?>
                                    <span class="font-bold text-charcoal-900"><?php echo e($alumni->current_occupation); ?></span>
                                <?php else: ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alumni->current_company): ?>
                                    ...
                                    <span class="font-bold text-primary-700"><?php echo e($alumni->current_company); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alumni->education): ?>
                        <div class="mb-10">
                            ...
                            <div class="prose prose-charcoal max-w-none bg-charcoal-50 p-6 rounded-2xl border border-charcoal-100">
                                <?php echo nl2br(e($alumni->education)); ?>

                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alumni->bio): ?>
                        <div class="mb-10">
                            <h3 class="text-xl font-bold text-charcoal-900 mb-5 flex items-center">
                                <div class="w-8 h-8 rounded-lg bg-charcoal-100 text-charcoal-600 flex items-center justify-center mr-3">
                            ...
                            <div class="prose prose-lg prose-charcoal max-w-none prose-a:text-primary-600 hover:prose-a:text-primary-700">
                                <?php echo \App\Support\HtmlSanitizer::clean($alumni->bio); ?>

                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alumni->achievements): ?>
                        <div class="mb-6">
                            <h3 class="text-xl font-bold text-charcoal-900 mb-5 flex items-center">
                                <div class="w-8 h-8 rounded-lg bg-charcoal-100 text-charcoal-600 flex items-center justify-center mr-3">
                            ...
                            <div class="prose prose-lg prose-charcoal max-w-none prose-a:text-primary-600 hover:prose-a:text-primary-700">
                                <?php echo \App\Support\HtmlSanitizer::clean($alumni->achievements); ?>
            ...
            <div class="text-center pt-8">
                <a href="<?php echo e(route('alumni.index')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 text-sm font-bold text-charcoal-700 bg-white border-2 border-charcoal-200 rounded-xl hover:bg-charcoal-50 hover:text-primary-600 hover:border-primary-200 transition-all focus:ring-4 focus:ring-charcoal-100 group">
...
<?php endif; ?>
<?php /**PATH D:\Project\test\Web Jurusan\TOWEB\resources\views\frontend\alumni\show.blade.php ENDPATH**/ ?>