...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Unduhan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Unduhan']); ?>
                                ...
                                <tr class="bg-white border-b border-slate-100 hover:bg-slate-50 transition-colors">
                                    <td class="px-6 py-4 font-medium text-slate-900 whitespace-nowrap">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($doc->description): ?>
                                            <p class="text-xs text-slate-500 mt-1 ml-7 font-normal"><?php echo e($doc->description); ?></p>
                                    ...
                                    <td class="px-6 py-4">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($doc->category): ?>
                                            <span class="bg-slate-100 text-slate-700 px-2.5 py-0.5 rounded text-xs font-medium"><?php echo e($doc->category->name); ?></span>
                                        <?php else: ?>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="<?php echo e(Storage::url($doc->file_path)); ?>" target="_blank" class="inline-flex items-center justify-center font-medium text-red-600 hover:text-red-700 bg-red-50 hover:bg-red-100 px-3 py-1.5 rounded-lg transition-colors">
