                    ...
                    <div class="bg-white border border-[#E4E1E5] p-8 shadow-sm">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
                            <div class="mb-6 bg-green-50 border border-green-200 text-green-700 px-4 py-3 relative" role="alert">
                                <span class="block sm:inline font-['Hanken_Grotesk']"><?php echo e(session('success')); ?></span>
                            </div>
...
<?php endif; ?>
<?php /**PATH D:\Project\test\Web Jurusan\TOWEB\resources\views\frontend\contact\index.blade.php ENDPATH**/ ?>