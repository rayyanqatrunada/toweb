...
<?php endif; ?>
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-charcoal-900 tracking-tight leading-[1.1] mt-4 mb-6">
                        <?php echo e($settings->get('site_name', 'Teknik Otomotif')); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                    ...
                    <div class="sticky top-32">
                        ...
                        <ul class="space-y-6">
                            <li class="pb-6 border-b border-charcoal-200">
                                ...
                                <span class="block font-bold text-charcoal-900"><?php echo e($settings->get('site_name', 'Jurusan Teknik Otomotif')); ?></span>
                            </li>
                            <li class="pb-6 border-b border-charcoal-200">
                ...
                <div class="lg:col-span-8 reveal-on-scroll reveal-up">
                    ...
                    <div class="prose prose-lg prose-charcoal prose-p:leading-relaxed prose-a:text-primary-600 hover:prose-a:text-primary-700 max-w-none">
                        <?php echo \App\Support\HtmlSanitizer::clean($settings->get('profile_history', '<p>Sejarah singkat jurusan Teknik Otomotif bermula dari dedikasi kami untuk mencetak tenaga kerja profesional. Dengan fasilitas yang terus berkembang, kami selalu berusaha menyesuaikan kurikulum dengan teknologi terkini di dunia otomotif.</p>')); ?>
                ...
                <div class="lg:col-span-7">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($programs) && $programs->isNotEmpty()): ?>
                        <div class="flex flex-col gap-4">
                            ...
                            <a href="<?php echo e(route('academic.programs')); ?>#<?php echo e($program->slug); ?>" class="group flex items-start p-6 rounded-2xl border border-charcoal-100 hover:border-primary-200 hover:bg-charcoal-50 transition-all focus-ring reveal-on-scroll reveal-up delay-<?php echo e($index * 100); ?>">
...
<?php endif; ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8">
                ...
                <a href="<?php echo e(route('academic.facilities')); ?>" class="group block relative aspect-square rounded-2xl overflow-hidden focus-ring reveal-on-scroll reveal-up delay-<?php echo e($loop->iteration * 100); ?>">
