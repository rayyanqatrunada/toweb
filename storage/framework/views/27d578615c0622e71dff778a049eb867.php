    ...
    <section class="flex flex-col items-center bg-[#F5F3F6] py-16 lg:py-[96px] px-6 lg:px-[64px] w-full border-t border-[#E4E1E5]">
        <div class="flex flex-col w-full max-w-[1280px] z-10 reveal-on-scroll reveal-up">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 w-full">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $otherAlumnis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alumni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="<?php echo e(route('alumni.show', $alumni->slug)); ?>" class="group relative flex flex-col items-center bg-[#FBF8FC] border border-[#E4E1E5] p-4 overflow-hidden hover:border-[#B70011] transition-colors">
                    <div class="w-full aspect-[3/4] relative overflow-hidden mb-4 bg-gray-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alumni->photo): ?>
                            <img src="<?php echo e(Storage::url($alumni->photo)); ?>" alt="<?php echo e($alumni->name); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <?php else: ?>
                    ...
                    <h3 class="font-heading font-bold text-[18px] text-[#1B1B1E] group-hover:text-[#B70011] text-center line-clamp-1 w-full"><?php echo e($alumni->name); ?></h3>
                    <p class="font-sans text-[14px] text-[#5F5E5E] text-center mb-1">Angkatan <?php echo e($alumni->graduation_year); ?></p>
                    <p class="font-sans font-medium text-[12px] text-[#B70011] text-center uppercase tracking-wide line-clamp-1"><?php echo e($alumni->current_occupation ?: 'Alumni'); ?></p>
                </a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
