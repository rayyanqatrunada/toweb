                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                        ...
                        <div class="lg:col-span-5 xl:col-span-4 flex flex-col gap-3 reveal-on-scroll reveal-up delay-100">
                            ...
                            <div class="flex items-center justify-between bg-white p-4 rounded-[2px] shadow-[0_1px_2px_rgba(0,0,0,0.05)] border border-[#E4E1E5]/60">
                                <div>
                                    <span class="font-heading font-bold text-[36px] leading-[40px] tracking-[-0.4px] text-[#1B1B1E]"><?php echo e($totalAchievements); ?>+</span>
                            ...
                            <div class="flex items-center justify-between bg-white p-4 rounded-[2px] shadow-[0_1px_2px_rgba(0,0,0,0.05)] border border-[#E4E1E5]/60">
                                <div>
                                    <span class="font-heading font-bold text-[36px] leading-[40px] tracking-[-0.4px] text-[#DC2626]"><?php echo e($nationalCount); ?></span>
                        ...
                        <div id="roadmap-scroll" class="flex gap-6 overflow-x-auto pb-6 relative z-10" style="-webkit-overflow-scrolling: touch;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentAchievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $ra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <div class="roadmap-card flex flex-col flex-shrink-0 w-[290px] min-w-[290px] relative">
                                    ...
                                    <div class="absolute top-[17px] -right-[13px] w-[2px] h-[22px] <?php echo e($idx === count($recentAchievements) - 1 ? 'bg-[#DC2626]' : 'bg-[#C4C0C6]'); ?> rounded-full hidden md:block z-20 shadow-sm"></div>
                                    ...
                                    <div class="flex items-center gap-3 mb-4 h-12">
                                        ...
                                        <div>
                                            <span class="inline-block px-2 py-0.5 rounded-[2px] font-sans font-bold text-[11px] tracking-[1px] uppercase <?php echo e($levelBg); ?>"><?php echo e($levelLabel); ?></span>
                                            <span class="block font-sans font-medium text-[12px] text-[#5F5E5E] mt-0.5"><?php echo e($ra->date ? $ra->date->format('M Y') : '—'); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-white rounded-[2px] shadow-[0_1px_2px_rgba(0,0,0,0.05)] border border-[#E4E1E5]/70 p-6 flex flex-col flex-grow">
                                        <div class="flex-grow">
                                            <span class="font-sans font-bold text-[11px] tracking-[1.2px] uppercase text-[#DC2626] mb-1.5 block"><?php echo e($ra->category ? $ra->category->name : 'Prestasi'); ?></span>
                                        ...
                                        <div class="flex items-center justify-between pt-3 mt-3 border-t border-[#F0EDF1] text-xs text-[#5F5E5E]">
                                            <span class="font-medium truncate max-w-[180px]"><?php echo e($ra->organizer); ?></span>
                                            <a href="<?php echo e(route('achievements.show', $ra->slug)); ?>" class="text-[#DC2626] font-semibold hover:underline flex-shrink-0">Detail &rarr;</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentAchievements->isNotEmpty()): ?>
                ...
                <div class="flex flex-col gap-8">
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 reveal-on-scroll reveal-up">
                        ...
                        <div class="flex items-center">
                            <span class="inline-block px-3 py-1 bg-[#E4E1E5] rounded-[2px] font-sans font-bold text-[11px] tracking-[1.2px] uppercase text-[#1B1B1E]">CURATED SELECTION &mdash; <?php echo e($featuredAchievements->count()); ?> ENTRIES</span>
                        </div>
                    </div>

                    
                    <div class="grid grid-cols-1 <?php echo e($featuredAchievements->count() > 1 ? 'lg:grid-cols-2' : 'max-w-3xl mx-auto w-full'); ?> gap-8">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $featuredAchievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fi => $feat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            ?>
                            <article class="bg-white rounded-[2px] shadow-[0_1px_2px_rgba(0,0,0,0.05)] border border-[#E4E1E5]/70 overflow-hidden flex flex-col reveal-on-scroll reveal-up" style="transition-delay: <?php echo e($fi * 80); ?>ms;">
                                ...
                                <div class="relative h-[260px] overflow-hidden">
                                    ...
                                    <div class="absolute top-4 left-4 flex items-center gap-2 z-10">
                                        <span class="px-3 py-1 bg-[#DC2626] rounded-[2px] font-sans font-bold text-[11px] tracking-[1px] uppercase text-white shadow-md"><?php echo e($rankText); ?> &bull; <?php echo e($levelLabel); ?></span>
                                        <span class="px-3 py-1 bg-[#303033] rounded-[2px] font-sans font-bold text-[11px] tracking-[1px] uppercase text-[#F3F0F4]"><?php echo e($feat->category ? $feat->category->name : 'Kompetisi'); ?></span>
                                    </div>
                                ...
                                <div class="p-6 flex flex-col flex-grow">
                                    ...
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isRedundantDesc && strlen($cleanDesc) > 20): ?>
                                        <p class="font-sans text-sm leading-relaxed text-[#5C403C] mb-4 line-clamp-2"><?php echo e(Str::limit($cleanDesc, 140)); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="flex flex-wrap items-center gap-x-3 gap-y-1.5 text-xs text-[#5F5E5E] font-medium pt-3 border-t border-[#F0EDF1] mt-auto">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($participantNames): ?>
                                            <span class="inline-flex items-center gap-1.5 text-[#1B1B1E] font-semibold">
                                                ...
                                                <?php echo e($participantNames); ?>

                                            </span>
                                            <span>&bull;</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <span>Penyelenggara: <strong class="text-[#1B1B1E] font-semibold"><?php echo e($feat->organizer); ?></strong></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($feat->date): ?>
                                            <span>&bull;</span>
                                            <span><?php echo e($feat->date->translatedFormat('d F Y')); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>

                                    
                                    <div class="pt-4 mt-3 flex justify-end">
                                        <a href="<?php echo e(route('achievements.show', $feat->slug)); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-[#303033] rounded-[2px] font-sans font-bold text-[11px] tracking-[1px] uppercase text-[#F3F0F4] hover:bg-[#1B1B1E] transition-colors">
                                            Lihat Detail
                ...
                <div class="flex flex-col gap-8">
                    ...
                    <div class="flex flex-col lg:flex-row lg:justify-between lg:items-end gap-4 reveal-on-scroll reveal-up">
                        ...
                        <form method="GET" action="<?php echo e(route('achievements.index')); ?>#arsip" class="relative w-full lg:w-[288px]">
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama kompetisi, siswa..." class="w-full pl-10 pr-4 py-2.5 bg-[#F0EDF1] rounded-[2px] font-sans text-sm text-[#1B1B1E] placeholder-[#5F5E5E] border-0 focus:ring-2 focus:ring-[#DC2626] outline-none">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 reveal-on-scroll reveal-up delay-100">
                        ...
                        <div class="flex items-center gap-2 flex-wrap">
                            <a href="<?php echo e(route('achievements.index', array_merge(request()->except('category','page'), []))); ?>#arsip"
                               class="px-4 py-2 rounded-[2px] font-sans font-bold text-[11px] tracking-[1.2px] uppercase <?php echo e(!request('category') ? 'bg-[#DC2626] text-white' : 'bg-[#F0EDF1] text-[#1B1B1E] hover:bg-[#E4E1E5]'); ?> transition-colors">
                                SEMUA
                            </a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <a href="<?php echo e(route('achievements.index', array_merge(request()->except('page'), ['category' => $cat->slug]))); ?>#arsip"
                                   class="px-4 py-2 rounded-[2px] font-sans font-bold text-[11px] tracking-[1.2px] uppercase <?php echo e(request('category') === $cat->slug ? 'bg-[#DC2626] text-white' : 'bg-[#F0EDF1] text-[#1B1B1E] hover:bg-[#E4E1E5]'); ?> transition-colors">
                                    <?php echo e($cat->name); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allAchievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ai => $ach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php
                                ...
                                $isRedundantDesc = str_contains(strtolower($cleanDesc), 'meraih juara') && str_contains(strtolower($cleanDesc), 'pada ajang');
                            ?>
                            <article class="bg-white rounded-[2px] shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-[#E4E1E5]/70 p-7 flex flex-col justify-between hover:shadow-md transition-shadow reveal-on-scroll reveal-up" style="transition-delay: <?php echo e(($ai % 3) * 50); ?>ms;">
                                <div>
                                    ...
                                    <div class="mb-4">
                                        <span class="inline-flex items-center gap-2 px-3 py-1 bg-[#F5F3F6] border border-[#E4E1E5] rounded-full text-xs font-semibold text-[#1B1B1E]">
                                            <span class="w-2 h-2 rounded-full <?php echo e($isJuara1 ? 'bg-[#DC2626]' : 'bg-[#303033]'); ?>"></span>
                                            <?php echo e($rankLabel); ?> &bull; <?php echo e($levelLabel); ?>
                                    ...
                                    <h3 class="font-heading font-bold text-lg text-[#1B1B1E] leading-snug hover:text-[#DC2626] transition-colors mb-3">
                                        <a href="<?php echo e(route('achievements.show', $ach->slug)); ?>">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isRedundantDesc && strlen($cleanDesc) > 20): ?>
                                        <p class="font-sans text-sm leading-relaxed text-[#5F5E5E] line-clamp-2 mb-4"><?php echo e(Str::limit($cleanDesc, 130)); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <div class="pt-4 border-t border-[#F0EDF1] mt-4 flex items-center justify-between text-xs text-[#5F5E5E]">
                                    <div class="flex flex-col gap-0.5 truncate pr-2">
                                        <span class="font-semibold text-[#1B1B1E] truncate"><?php echo e($participantNames ?: ($ach->category ? $ach->category->name : 'Teknik Otomotif')); ?></span>
                                        <span class="text-[11px] text-[#5F5E5E] truncate"><?php echo e($ach->organizer); ?><?php echo e($ach->date ? ' • ' . $ach->date->format('Y') : ''); ?></span>
                                    </div>
                                    <a href="<?php echo e(route('achievements.show', $ach->slug)); ?>" class="inline-flex items-center gap-1 font-semibold text-[#303033] hover:text-[#DC2626] transition-colors flex-shrink-0">
                                        Detail
