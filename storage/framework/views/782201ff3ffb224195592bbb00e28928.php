            ...
            <div class="w-full lg:w-5/12 bg-charcoal-950 p-8 md:p-12 text-white relative overflow-hidden group rounded-2xl shadow-xl flex flex-col justify-between">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($headOfDepartment): ?>
                    ...
                    <div class="flex flex-col h-full z-10 relative">
                        ...
                        <h4 class="font-heading font-bold text-[28px] md:text-[32px] leading-tight mb-2 text-white"><?php echo e($headOfDepartment->name); ?></h4>
                        <p class="font-sans text-[15px] font-medium text-figma-red mb-6"><?php echo e($headOfDepartment->position ?? 'Ketua Kompetensi Keahlian TBSM'); ?></p>
