...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Kontak & Lokasi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Kontak & Lokasi']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="w-full min-h-screen flex flex-col items-center relative">
        ...
        <!-- Background -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->get('header_contact_image')): ?>
            <img src="<?php echo e(Storage::url($settings->get('header_contact_image'))); ?>" alt="Contact Background" class="absolute inset-0 z-0 w-full h-full object-cover opacity-15 pointer-events-none">
        <?php else: ?>
            <!-- Gradient Overlay -->
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="max-w-[1152px] mx-auto w-full flex flex-col gap-4 relative z-10">
                ...
                <p class="font-['Hanken_Grotesk'] text-base md:text-lg leading-[29px] text-[#5C403C] max-w-[672px] mt-1">
                    Hubungi departemen <?php echo e($settings->get('site_name', 'Teknik Sepeda Motor')); ?> SMK Negeri 1 Bangsri untuk informasi akademik, kemitraan industri, atau pertanyaan umum. Kami siap membantu Anda.
                </p>
            </div>
        </section>
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex items-start gap-4 pb-6 border-b border-[#E4E1E5]">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <span class="font-['Hanken_Grotesk'] text-base leading-6 text-[#1B1B1E]"><?php echo nl2br(e($settings->get('contact_address', 'Jl. KH. Achmad Fauzan No. 17, Bangsri, Jepara'))); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4 py-6 border-b border-[#E4E1E5]">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <a href="tel:<?php echo e($settings->get('contact_phone', '0291 771337')); ?>" class="font-['Hanken_Grotesk'] text-base leading-6 text-[#1B1B1E] hover:text-[#DC2626] transition-colors"><?php echo e($settings->get('contact_phone', '0291 771337')); ?></a>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4 py-6 border-b border-[#E4E1E5]">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <a href="mailto:<?php echo e($settings->get('contact_email', 'otomotif@smkn1bangsri.sch.id')); ?>" class="font-['Hanken_Grotesk'] text-base leading-6 text-[#B70011] relative inline-block group">
                                            <?php echo e($settings->get('contact_email', 'otomotif@smkn1bangsri.sch.id')); ?>
                                ...
                                <div class="flex items-start gap-4 pt-6">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <span class="font-['Hanken_Grotesk'] text-base leading-6 text-[#1B1B1E]"><?php echo e($settings->get('contact_operating_hours', 'Senin - Jumat: 07:00 - 15:30 WIB')); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-5">
                    <div class="bg-white border border-[#E4E1E5] relative overflow-hidden">
                        ...
                        <div class="p-6 md:p-8">
                            ...
                            <form action="<?php echo e(route('contact.store')); ?>" method="POST" class="flex flex-col gap-6 relative z-10">
                                <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-500 font-['Hanken_Grotesk']"><?php echo e($message); ?></span> <?php unset($message);
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <div class="relative">
                                        <select name="subject" id="subject" 
                                            ...
                                            <option value="" disabled <?php echo e(old('subject') ? '' : 'selected'); ?>>Pilih Keperluan</option>
                                            <option value="Informasi Akademik" <?php echo e(old('subject') == 'Informasi Akademik' ? 'selected' : ''); ?>>Informasi Akademik</option>
                                            <option value="Kemitraan Industri" <?php echo e(old('subject') == 'Kemitraan Industri' ? 'selected' : ''); ?>>Kemitraan Industri</option>
                                            <option value="Pertanyaan Umum" <?php echo e(old('subject') == 'Pertanyaan Umum' ? 'selected' : ''); ?>>Pertanyaan Umum</option>
                                            <option value="Lainnya" <?php echo e(old('subject') == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                                        </select>
        ...
        <section class="w-full bg-[#F5F3F6] border-t border-[#E4E1E5]">
            <div class="max-w-[1440px] mx-auto py-12 px-6 md:px-16 flex flex-col md:flex-row justify-between items-center gap-8">
                <div class="flex flex-col gap-2">
                    ...
                    <p class="font-['Hanken_Grotesk'] text-base text-[#5C403C]">Ikuti perkembangan terbaru departemen <?php echo e($settings->get('site_name', 'Teknik Sepeda Motor')); ?> (<?php echo e($settings->get('site_short_name', 'TSM')); ?>).</p>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="<?php echo e($settings->get('social_instagram')); ?>" target="_blank" rel="noopener noreferrer" class="w-12 h-12 bg-white border border-[#E4E1E5] flex items-center justify-center text-[#1B1B1E] hover:bg-[#DC2626] hover:text-white hover:border-[#DC2626] transition-all duration-200" aria-label="Instagram">
                    ...
                    <a href="<?php echo e($settings->get('social_facebook')); ?>" target="_blank" rel="noopener noreferrer" class="w-12 h-12 bg-white border border-[#E4E1E5] flex items-center justify-center text-[#1B1B1E] hover:bg-[#DC2626] hover:text-white hover:border-[#DC2626] transition-all duration-200" aria-label="Facebook">
                    ...
                    <a href="<?php echo e($settings->get('social_youtube')); ?>" target="_blank" rel="noopener noreferrer" class="w-12 h-12 bg-white border border-[#E4E1E5] flex items-center justify-center text-[#1B1B1E] hover:bg-[#DC2626] hover:text-white hover:border-[#DC2626] transition-all duration-200" aria-label="YouTube">
...
<?php endif; ?>
<?php /**PATH /home/Rayy/Project/Github/TBSM WEB/toweb/resources/views/frontend/contact/index.blade.php ENDPATH**/ ?>