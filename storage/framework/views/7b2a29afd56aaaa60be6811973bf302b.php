                    ...
                    <div class="flex flex-col h-full z-10 relative">
                        ...
                        <div class="w-32 h-32 md:w-48 md:h-48 bg-charcoal-800 rounded-full overflow-hidden mb-8 border-4 border-charcoal-800 shadow-xl mx-auto md:mx-0">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($headOfDepartment->photo): ?>
                                <img src="<?php echo e(Storage::url($headOfDepartment->photo)); ?>" alt="<?php echo e($headOfDepartment->name); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                                <div class="w-full h-full flex items-center justify-center font-heading font-bold text-4xl text-gray-500"><?php echo e(substr($headOfDepartment->name, 0, 1)); ?></div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        
                        <h4 class="font-heading font-bold text-[32px] leading-tight mb-2"><?php echo e($headOfDepartment->name); ?></h4>
                        <p class="font-sans text-[16px] text-gray-400 mb-6"><?php echo e($headOfDepartment->position ?? 'Guru Kejuruan Otomotif'); ?></p>
            ...
            <div class="w-full lg:w-7/12 flex flex-col gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teachers && $teachers->count() > 0): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="flex flex-col sm:flex-row items-center sm:items-start p-6 md:p-8 bg-white border border-gray-200 hover:shadow-lg transition-shadow duration-300 gap-6 group">
                            <div class="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden shrink-0 bg-gray-100 border-2 border-gray-100 group-hover:border-figma-red transition-colors duration-300">
                                ...
                                <?php else: ?>
                                    <div class="w-full h-full flex items-center justify-center font-heading font-bold text-2xl text-gray-400"><?php echo e(substr($teacher->name, 0, 1)); ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            
                            <div class="text-center sm:text-left flex-1">
                                <h4 class="font-heading font-bold text-[22px] md:text-[24px] text-figma-dark mb-1 group-hover:text-figma-red transition-colors"><?php echo e($teacher->name); ?></h4>
                                <p class="font-sans text-[15px] text-figma-gray mb-3"><?php echo e($teacher->position ?? 'Guru Kejuruan Otomotif'); ?></p>
                    ...
                    <div class="mt-4 flex justify-center lg:justify-start">
                        <a href="<?php echo e(route('academic.teachers')); ?>" class="inline-flex items-center justify-center px-8 py-3 border border-gray-300 text-figma-dark font-sans font-bold text-[14px] uppercase tracking-wide hover:bg-gray-100 transition-colors focus-ring">
...
<?php /**PATH D:\Project\test\Web Jurusan\TOWEB\resources\views/components/frontend/home/teachers.blade.php ENDPATH**/ ?>