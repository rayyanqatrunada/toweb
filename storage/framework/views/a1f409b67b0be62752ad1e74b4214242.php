...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                ...
                <div class="text-center md:text-left flex-grow">
                    ...
                    <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight"><?php echo e($partner->name); ?></h1>
                    ...
                    <div class="flex flex-col sm:flex-row flex-wrap items-center justify-center md:justify-start gap-4 md:gap-8 text-charcoal-300 text-sm font-medium">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($partner->website): ?>
                            <a href="<?php echo e(Str::startsWith($partner->website, 'http') ? $partner->website : 'https://'.$partner->website); ?>" target="_blank" class="flex items-center hover:text-white transition-colors group">
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="mt-16 pt-8 border-t border-charcoal-100 text-center">
                <a href="<?php echo e(route('partnership.index')); ?>" class="inline-flex items-center justify-center px-6 py-3 text-sm font-bold text-charcoal-700 bg-white border-2 border-charcoal-200 rounded-xl hover:bg-charcoal-50 hover:text-primary-600 hover:border-primary-200 transition-all focus:ring-4 focus:ring-charcoal-50 group">
