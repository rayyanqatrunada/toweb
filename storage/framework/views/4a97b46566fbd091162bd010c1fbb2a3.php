<nav x-data="{ 
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="flex-1 overflow-y-auto px-6 py-6 space-y-6">
            <a href="<?php echo e(route('home')); ?>" class="block font-sans text-xl tracking-[-0.8px] uppercase <?php echo e(request()->routeIs('home') ? 'text-figma-dark font-bold' : 'text-figma-gray'); ?>">Beranda</a>
            <a href="<?php echo e(route('about')); ?>" class="block font-sans text-xl tracking-[-0.8px] uppercase <?php echo e(request()->routeIs('about') ? 'text-figma-dark font-bold' : 'text-figma-gray'); ?>">Tentang</a>
            <a href="<?php echo e(route('academic.programs')); ?>" class="block font-sans text-xl tracking-[-0.8px] uppercase <?php echo e(request()->is('akademik*') ? 'text-figma-dark font-bold' : 'text-figma-gray'); ?>">Akademik</a>
            <a href="<?php echo e(route('partnership.index')); ?>" class="block font-sans text-xl tracking-[-0.8px] uppercase <?php echo e(request()->is('mitra-industri*') || request()->is('pkl*') || request()->is('lowongan*') ? 'text-figma-dark font-bold' : 'text-figma-gray'); ?>">Industri</a>
            <a href="<?php echo e(route('news.index')); ?>" class="block font-sans text-xl tracking-[-0.8px] uppercase <?php echo e(request()->is('berita*') || request()->is('pengumuman*') || request()->is('prestasi*') || request()->is('galeri*') || request()->is('alumni*') || request()->is('unduhan*') ? 'text-figma-dark font-bold' : 'text-figma-gray'); ?>">Publikasi</a>
            
            <a href="<?php echo e(route('about')); ?>#contact" class="block text-center mt-8 px-6 py-3 bg-figma-red text-white font-sans text-lg uppercase rounded-[2px] hover:bg-figma-dark-red transition-colors">Hubungi Kami</a>
        </div>
    </div>
</nav>
