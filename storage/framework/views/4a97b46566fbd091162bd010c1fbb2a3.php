<nav x-data="{ 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center transition-all duration-300" :class="scrolled ? 'h-16' : 'h-20'">
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-8 lg:justify-end flex-grow ml-8">
                <a href="<?php echo e(route('home')); ?>" class="text-xs font-bold uppercase tracking-wider transition-colors <?php echo e(request()->routeIs('home') ? 'text-charcoal-900' : 'text-charcoal-500 hover:text-charcoal-900'); ?>">Beranda</a>
                
                <a href="<?php echo e(route('about')); ?>" class="text-xs font-bold uppercase tracking-wider transition-colors <?php echo e(request()->routeIs('about') ? 'text-charcoal-900' : 'text-charcoal-500 hover:text-charcoal-900'); ?>">Tentang</a>

                <!-- Akademik Link -->
                <a href="<?php echo e(route('academic.programs')); ?>" class="text-xs font-bold uppercase tracking-wider transition-colors <?php echo e(request()->is('akademik*') ? 'text-charcoal-900' : 'text-charcoal-500 hover:text-charcoal-900'); ?>">Akademik</a>

                <!-- Industri Link -->
                <a href="<?php echo e(route('partnership.index')); ?>" class="text-xs font-bold uppercase tracking-wider transition-colors <?php echo e(request()->is('pkl*') || request()->is('mitra-industri*') || request()->is('lowongan*') ? 'text-charcoal-900' : 'text-charcoal-500 hover:text-charcoal-900'); ?>">Industri</a>
                
                <!-- Publikasi Link -->
                <a href="<?php echo e(route('news.index')); ?>" class="text-xs font-bold uppercase tracking-wider transition-colors <?php echo e(request()->is('berita*') || request()->is('pengumuman*') || request()->is('prestasi*') || request()->is('galeri*') || request()->is('alumni*') || request()->is('unduhan*') ? 'text-charcoal-900' : 'text-charcoal-500 hover:text-charcoal-900'); ?>">Publikasi</a>
            </div>
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="flex-1 overflow-y-auto px-6 py-6 space-y-6">
            ...
            <a href="<?php echo e(route('home')); ?>" class="block text-xl font-bold uppercase tracking-wider <?php echo e(request()->routeIs('home') ? 'text-charcoal-900' : 'text-charcoal-500'); ?>">Beranda</a>
            <a href="<?php echo e(route('about')); ?>" class="block text-xl font-bold uppercase tracking-wider <?php echo e(request()->routeIs('about') ? 'text-charcoal-900' : 'text-charcoal-500'); ?>">Tentang</a>
            
            <a href="<?php echo e(route('academic.programs')); ?>" class="block text-xl font-bold uppercase tracking-wider <?php echo e(request()->is('akademik*') ? 'text-charcoal-900' : 'text-charcoal-500'); ?>">Akademik</a>
            
            <a href="<?php echo e(route('partnership.index')); ?>" class="block text-xl font-bold uppercase tracking-wider <?php echo e(request()->is('mitra-industri*') || request()->is('pkl*') || request()->is('lowongan*') ? 'text-charcoal-900' : 'text-charcoal-500'); ?>">Industri</a>
            
            <a href="<?php echo e(route('news.index')); ?>" class="block text-xl font-bold uppercase tracking-wider <?php echo e(request()->is('berita*') || request()->is('pengumuman*') || request()->is('prestasi*') || request()->is('galeri*') || request()->is('alumni*') || request()->is('unduhan*') ? 'text-charcoal-900' : 'text-charcoal-500'); ?>">Publikasi</a>
