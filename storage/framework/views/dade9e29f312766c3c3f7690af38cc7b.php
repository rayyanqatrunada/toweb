...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['title' => 'Belum Ada Data', 'message' => 'Data untuk halaman ini belum tersedia.', 'icon' => 'document']));
...
foreach (array_filter((['title' => 'Belum Ada Data', 'message' => 'Data untuk halaman ini belum tersedia.', 'icon' => 'document']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="col-span-full py-20 px-4">
    <div class="max-w-md mx-auto bg-slate-50 border border-dashed border-slate-300 rounded-2xl p-10 text-center">
        <div class="w-16 h-16 mx-auto bg-white border border-slate-200 text-slate-400 rounded-2xl flex items-center justify-center mb-5 shadow-sm transform -rotate-3 hover:rotate-0 transition-transform">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($icon === 'document'): ?>
        ...
        <p class="text-slate-500 text-sm leading-relaxed"><?php echo e($message); ?></p>
    </div>
</div>
<?php /**PATH /home/Rayy/Project/Github/TBSM WEB/toweb/resources/views/components/empty-state.blade.php ENDPATH**/ ?>