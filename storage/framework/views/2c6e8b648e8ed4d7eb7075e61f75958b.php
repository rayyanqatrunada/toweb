...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="bg-charcoal-50 pt-10 pb-14 lg:pt-14 lg:pb-20 relative overflow-hidden border-b border-charcoal-200">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->get('header_partnership_image')): ?>
            <img src="<?php echo e(Storage::url($settings->get('header_partnership_image'))); ?>" alt="Internships Background" class="absolute inset-0 z-0 w-full h-full object-cover opacity-15 pointer-events-none">
        <?php else: ?>
...
<?php /**PATH /home/Rayy/Project/Github/TBSM WEB/toweb/resources/views/frontend/internships/index.blade.php ENDPATH**/ ?>