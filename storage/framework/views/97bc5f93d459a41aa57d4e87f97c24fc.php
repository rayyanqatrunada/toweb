...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'full','headline' => ''.$settings->get('hero_title', 'Menyiapkan Generasi Profesional di Dunia Otomotif').'','description' => ''.$settings->get('hero_subtitle', 'Kami mendidik siswa menjadi mekanik, teknisi, dan wirausahawan andal dengan fasilitas standar industri dan penyaluran kerja yang terjamin.').'','image-url' => 'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?q=80&w=2000&auto=format&fit=crop','eyebrow-text' => 'PUSAT KEUNGGULAN (COE)']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <div class="lg:col-span-5 relative mb-16 lg:mb-0">
                    ...
                    <div class="absolute -bottom-8 -right-4 sm:-right-8 md:bottom-8 bg-white p-6 rounded-2xl shadow-xl border border-slate-100 max-w-[280px] z-10 hidden sm:block">
                        ...
                        <p class="text-slate-900 font-bold italic text-sm leading-relaxed">
                            "<?php echo $settings->get('head_quote', 'Menyiapkan lulusan yang bukan hanya paham mesin, tapi memiliki karakter profesional industri.'); ?>"
                        </p>
