...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.hero.index','data' => ['variant' => 'full','headline' => ''.\App\Support\HtmlSanitizer::clean($settings->get('hero_title', 'Menyiapkan Generasi Profesional di Dunia Otomotif')).'','description' => ''.\App\Support\HtmlSanitizer::clean($settings->get('hero_subtitle', 'Kami mendidik siswa menjadi mekanik, teknisi, dan wirausahawan andal dengan fasilitas standar industri dan penyaluran kerja yang terjamin.')).'','imageUrl' => 'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?q=80&w=2000&auto=format&fit=crop','eyebrowText' => 'PUSAT KEUNGGULAN (COE)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'full','headline' => ''.\App\Support\HtmlSanitizer::clean($settings->get('hero_title', 'Menyiapkan Generasi Profesional di Dunia Otomotif')).'','description' => ''.\App\Support\HtmlSanitizer::clean($settings->get('hero_subtitle', 'Kami mendidik siswa menjadi mekanik, teknisi, dan wirausahawan andal dengan fasilitas standar industri dan penyaluran kerja yang terjamin.')).'','image-url' => 'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?q=80&w=2000&auto=format&fit=crop','eyebrow-text' => 'PUSAT KEUNGGULAN (COE)']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative -top-8 z-20">
            <div class="bg-white rounded-2xl shadow-xl shadow-slate-900/50 p-8 border border-slate-100">
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 divide-x divide-slate-100">
                    ...
                    <div class="text-center px-4" x-intersect.once="startAnimation(<?php echo e($alumniCount ?: 1200); ?>, 'c1')">
                    ...
                    <div class="text-center px-4" x-intersect.once="startAnimation(<?php echo e($partnerCount ?: 45); ?>, 'c2')">
                    ...
                    <div class="text-center px-4" x-intersect.once="startAnimation(<?php echo e($achievementCount ?: 12); ?>, 'c3')">
                    ...
                    <div class="text-center px-4" x-intersect.once="startAnimation(<?php echo e($facilityCount ?: 8); ?>, 'c4')">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
                ...
                <div class="lg:col-span-5 relative mb-16 lg:mb-0">
                    ...
                    <div class="absolute -bottom-8 -right-4 sm:-right-8 md:bottom-8 bg-white p-6 rounded-2xl shadow-xl border border-slate-100 max-w-[280px] z-10 hidden sm:block">
                        ...
                        <p class="text-slate-900 font-bold italic text-sm leading-relaxed">
                            "<?php echo \App\Support\HtmlSanitizer::clean($settings->get('head_quote', 'Menyiapkan lulusan yang bukan hanya paham mesin, tapi memiliki karakter profesional industri.')); ?>"
                        </p>
                        <p class="mt-3 text-xs font-extrabold text-slate-500 uppercase tracking-widest">- <?php echo e(isset($headOfDepartment) ? $headOfDepartment->name : 'Kepala Jurusan'); ?></p>
                    </div>
                </div>
                ...
                <div class="lg:col-span-7 flex flex-col justify-center">
                    ...
                    <div class="mt-8">
                        <a href="<?php echo e(route('about') ?? '/profil'); ?>" class="inline-flex items-center px-6 py-3 border border-slate-200 shadow-sm text-base font-bold rounded-lg text-slate-900 bg-white hover:bg-slate-50 hover:text-red-600 transition-colors">
                            Baca Selengkapnya
...
<?php endif; ?>
            ...
            <div class="flex overflow-x-auto snap-x snap-mandatory pb-8 md:pb-0 md:grid md:grid-cols-2 lg:grid-cols-3 gap-6" style="scrollbar-width: none;">
                ...
                <a href="<?php echo e(route('academic.programs')); ?>#<?php echo e($program->slug); ?>" class="group relative block h-[420px] w-full rounded-2xl overflow-hidden bg-slate-900 snap-center min-w-[85vw] md:min-w-0 flex-shrink-0 shadow-lg <?php if($loop->iteration == 3): ?> lg:col-span-1 md:col-span-2 <?php endif; ?> focus-visible:ring-4 focus-visible:ring-red-500 focus:outline-none">
                    <img src="<?php echo e($program->thumbnail ? Storage::url($program->thumbnail) : 'https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?q=80&w=800&auto=format&fit=crop'); ?>" alt="<?php echo e($program->name); ?>" class="absolute inset-0 h-full w-full object-cover transition-transform duration-700 ease-in-out group-hover:scale-105 group-hover:opacity-60 opacity-80 md:opacity-90" loading="lazy">
                    ...
                    <div class="absolute inset-x-0 bottom-0 p-6 md:p-8 flex flex-col justify-end h-full">
                        ...
                        <h3 class="text-2xl font-bold text-white mb-2 transform transition-transform duration-300 md:group-hover:-translate-y-4"><?php echo e($program->name); ?></h3>
                        <p class="text-slate-300 text-sm md:text-base line-clamp-2 md:group-hover:opacity-0 transition-opacity duration-300 md:group-hover:absolute md:group-hover:invisible focus-within:opacity-0"><?php echo e(Str::limit(strip_tags($program->description), 100)); ?></p>
                        ...
                        <div class="mt-4 md:absolute md:bottom-8 md:opacity-0 md:translate-y-4 md:group-hover:opacity-100 focus-within:opacity-100 focus-within:translate-y-0 md:group-hover:translate-y-0 transition-all duration-300 hidden md:block">
                            ...
                            <ul class="text-white text-sm space-y-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $program->competencies->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <li class="flex items-center"><svg class="h-4 w-4 mr-2 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> <?php echo e($comp->name); ?></li>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Belum Ada Program','message' => 'Data program keahlian belum tersedia saat ini.','icon' => 'document']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Program','message' => 'Data program keahlian belum tersedia saat ini.','icon' => 'document']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-10">
                ...
                <div class="mt-4 md:mt-0">
                    <a href="<?php echo e(route('academic.facilities')); ?>" class="text-sm font-bold text-slate-300 hover:text-white flex items-center transition-colors">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <?php $featuredFacility = $facilities->first(); ?>
                <!-- Featured (Kiri: 8 Kolom) -->
                <div class="lg:col-span-8">
                    <a href="<?php echo e(route('academic.facilities')); ?>" class="group relative block w-full h-[400px] md:h-[500px] lg:h-full rounded-2xl overflow-hidden focus:outline-none focus:ring-4 focus:ring-red-500">
                        <img src="<?php echo e($featuredFacility->photo ? Storage::url($featuredFacility->photo) : 'https://images.unsplash.com/photo-1632823465306-cdbb32ab7586?q=80&w=1200&auto=format&fit=crop'); ?>" alt="<?php echo e($featuredFacility->name); ?>" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 ease-in-out group-hover:scale-105" loading="lazy">
                        ...
                        <div class="absolute inset-0 p-6 md:p-10 flex flex-col justify-end">
                            ...
                            <h3 class="text-2xl md:text-3xl font-bold text-white mb-2"><?php echo e($featuredFacility->name); ?></h3>
                            <p class="text-slate-300 line-clamp-2 md:text-lg max-w-2xl font-medium">
                                <?php echo e(Str::limit(strip_tags($featuredFacility->description), 120)); ?>
                ...
                <div class="lg:col-span-4 flex flex-col gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $facilities->skip(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('academic.facilities')); ?>" class="group flex flex-col sm:flex-row lg:flex-col gap-4 bg-slate-800/80 hover:bg-slate-800 rounded-2xl p-4 transition-all duration-300 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-red-500 h-full border border-slate-700">
                        <div class="relative w-full sm:w-1/3 lg:w-full aspect-video rounded-xl overflow-hidden flex-shrink-0">
                            <img src="<?php echo e($facility->photo ? Storage::url($facility->photo) : 'https://images.unsplash.com/photo-1579730537446-5ec5e1b7b7dd?q=80&w=600&auto=format&fit=crop'); ?>" alt="<?php echo e($facility->name); ?>" class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" loading="lazy">
                        </div>
                        <div class="flex flex-col flex-1 justify-center p-1">
                            ...
                            <h4 class="text-lg font-bold text-white group-hover:text-red-400 transition-colors"><?php echo e($facility->name); ?></h4>
                            <p class="text-slate-400 text-sm mt-1 line-clamp-2"><?php echo e(Str::limit(strip_tags($facility->description), 80)); ?></p>
                        </div>
                    </a>
                ...
                <div class="col-span-full">
                    <?php if (isset($component)) { $__componentOriginal074a021b9d42f490272b5eefda63257c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal074a021b9d42f490272b5eefda63257c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Belum Ada Fasilitas','message' => 'Data fasilitas belum tersedia saat ini.','icon' => 'document']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('empty-state'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Fasilitas','message' => 'Data fasilitas belum tersedia saat ini.','icon' => 'document']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <div class="mt-8 md:hidden">
                <a href="<?php echo e(route('academic.facilities')); ?>" class="flex justify-center px-4 py-3 bg-slate-800 hover:bg-slate-700 rounded-lg text-white font-bold transition-colors">
                    Lihat Seluruh Fasilitas
                </a>
            </div>
        </div>
                ...
                <div class="lg:col-span-7">
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-3 sm:grid-cols-4 gap-6 items-center">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $partners->take(7); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e(route('partnership.show', $partner->slug) ?? '#'); ?>" class="flex items-center justify-center p-4 bg-slate-50 rounded-xl grayscale hover:grayscale-0 transition-all border border-slate-100 hover:border-red-200 hover:shadow-md cursor-pointer" title="<?php echo e($partner->name); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($partner->logo): ?>
                                    <img src="<?php echo e(Storage::url($partner->logo)); ?>" alt="<?php echo e($partner->name); ?>" class="max-h-12 max-w-full object-contain" loading="lazy">
                                <?php else: ?>
                                    <span class="font-bold text-slate-400 text-xs text-center"><?php echo e($partner->name); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <div class="col-span-full">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <a href="<?php echo e(route('partnership.index') ?? '/kemitraan'); ?>" class="flex items-center justify-center p-4 bg-slate-50 rounded-xl hover:bg-red-50 text-red-600 transition-all border border-slate-100 hover:border-red-200 cursor-pointer h-full min-h-[80px]">
                ...
                <div class="lg:col-span-5 relative mt-12 lg:mt-0">
                    <div class="bg-slate-50 rounded-2xl p-6 md:p-8 border border-slate-100 h-full shadow-inner relative overflow-hidden">
                        ...
                        <div class="flex justify-between items-center mb-6 relative z-10">
                            ...
                            <span class="bg-red-100 text-red-700 text-xs font-bold px-3 py-1 rounded-full"><?php echo e($jobVacancies->count()); ?> Lowongan Aktif</span>
                        </div>
                        ...
                        <div class="space-y-4 relative z-10">
                            ...
                            <a href="<?php echo e(route('jobs.show', $job->slug) ?? '#'); ?>" class="block bg-white p-5 rounded-xl shadow-sm border border-slate-200 hover:border-red-300 hover:shadow-md transition-all duration-300 hover:-translate-y-1 group reveal-on-scroll reveal-up focus-visible:ring-4 focus-visible:ring-red-500 focus:outline-none">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <h4 class="font-bold text-slate-900 group-hover:text-red-600 transition-colors"><?php echo e($job->title); ?></h4>
                                        <p class="text-sm text-slate-500 mt-0.5"><?php echo e($job->industryPartner->name ?? $job->position); ?></p>
                                    </div>
                                    <span class="text-xs font-medium bg-slate-100 text-slate-600 px-2 py-1 rounded"><?php echo e(ucfirst(str_replace('_', ' ', $job->employment_type))); ?></span>
                                </div>
                                <div class="flex items-center text-xs text-slate-400 mt-4 space-x-4">
                                    ...
                                    <span class="flex items-center <?php echo e($job->application_deadline && $job->application_deadline->diffInDays(now()) <= 7 ? 'text-red-500' : ''); ?>"><svg class="w-3.5 h-3.5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> <?php echo e($job->application_deadline ? 'Tutup ' . $job->application_deadline->diffForHumans() : 'Dibuka Terus'); ?></span>
                                </div>
                            </a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginal074a021b9d42f490272b5eefda63257c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal074a021b9d42f490272b5eefda63257c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Tidak Ada Lowongan','message' => 'Belum ada lowongan baru saat ini.','icon' => 'document']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('empty-state'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Tidak Ada Lowongan','message' => 'Belum ada lowongan baru saat ini.','icon' => 'document']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-12">
                ...
                <div class="mt-6 md:mt-0">
                    <a href="<?php echo e(route('alumni.index') ?? '/alumni'); ?>" class="inline-flex items-center px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-white text-sm font-bold rounded-lg transition-colors border border-slate-700 focus:outline-none focus:ring-4 focus:ring-red-500">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                ...
                <div class="lg:col-span-8">
                    <div class="flex justify-between items-end mb-8">
                        ...
                        <a href="<?php echo e(route('news.index') ?? '/berita'); ?>" class="hidden sm:flex items-center text-sm font-bold text-slate-500 hover:text-red-600 transition-colors">
                            Lihat Semua Berita
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <article class="md:col-span-2 group bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-lg transition-all duration-300">
                            <a href="<?php echo e(route('news.show', $featuredNews->slug) ?? '#'); ?>" class="block relative aspect-[2/1] md:aspect-[2.5/1] overflow-hidden focus-visible:ring-4 focus-visible:ring-red-500 focus:outline-none">
                                <img src="<?php echo e($featuredNews->thumbnail ? Storage::url($featuredNews->thumbnail) : 'https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=800&auto=format&fit=crop'); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="<?php echo e($featuredNews->title); ?>" loading="lazy">
                                <div class="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent"></div>
                                <div class="absolute bottom-4 left-4 right-4">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredNews->category): ?>
                                    <span class="inline-block px-2.5 py-1 bg-red-600 text-white text-xs font-bold rounded mb-2"><?php echo e($featuredNews->category->name); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <h3 class="text-xl md:text-2xl font-bold text-white mb-1 group-hover:text-red-300 transition-colors"><?php echo e($featuredNews->title); ?></h3>
                                    <p class="text-slate-300 text-sm hidden md:block line-clamp-1"><?php echo e($featuredNews->excerpt ?? Str::limit(strip_tags($featuredNews->content), 100)); ?></p>
                                </div>
                            </a>
                        </article>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $latestNews->skip(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <!-- Standard News Card -->
                        <article class="group bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-lg transition-all duration-300 flex flex-col h-full">
                            <a href="<?php echo e(route('news.show', $news->slug) ?? '#'); ?>" class="block relative aspect-video overflow-hidden bg-slate-100 focus-visible:ring-4 focus-visible:ring-red-500 focus:outline-none">
                                <img src="<?php echo e($news->thumbnail ? Storage::url($news->thumbnail) : 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=600&auto=format&fit=crop'); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="<?php echo e($news->title); ?>" loading="lazy">
                                ...
                                <span class="absolute top-3 left-3 px-2.5 py-1 bg-red-600 text-white text-xs font-bold rounded shadow-sm"><?php echo e($news->category->name); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </a>
                            <div class="p-5 flex-1 flex flex-col">
                                <p class="text-xs text-slate-500 font-medium mb-2"><svg class="inline w-3 h-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg> <?php echo e($news->published_at ? $news->published_at->translatedFormat('d M Y') : $news->created_at->translatedFormat('d M Y')); ?></p>
                                <h3 class="text-lg font-bold text-slate-900 mb-2 group-hover:text-red-600 transition-colors leading-tight"><a href="<?php echo e(route('news.show', $news->slug) ?? '#'); ?>" class="focus:outline-none focus:underline"><?php echo e($news->title); ?></a></h3>
                                <p class="text-slate-600 text-sm line-clamp-2 mt-auto"><?php echo e($news->excerpt ?? Str::limit(strip_tags($news->content), 80)); ?></p>
                            </div>
                        </article>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <?php else: ?>
                        <div class="md:col-span-2">
                            <?php if (isset($component)) { $__componentOriginal074a021b9d42f490272b5eefda63257c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal074a021b9d42f490272b5eefda63257c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Belum Ada Berita','message' => 'Belum ada berita terbaru yang diterbitkan.','icon' => 'document']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('empty-state'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Berita','message' => 'Belum ada berita terbaru yang diterbitkan.','icon' => 'document']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <div class="lg:col-span-4 mt-12 lg:mt-0">
                    ...
                    <div class="bg-slate-50 rounded-2xl p-6 border border-slate-100 shadow-inner">
                        <div class="space-y-4">
                            ...
                            <a href="<?php echo e(route('announcements.show', $agenda->slug) ?? '#'); ?>" class="flex group bg-white rounded-xl overflow-hidden border border-slate-200 hover:border-red-300 hover:shadow-md transition-all focus-visible:ring-4 focus-visible:ring-red-500 focus:outline-none">
                                <div class="bg-red-50 text-red-700 px-4 py-3 flex flex-col items-center justify-center border-r border-slate-100 min-w-[70px]">
                                    <span class="text-xs font-bold uppercase tracking-wider"><?php echo e($agenda->created_at->translatedFormat('M')); ?></span>
                                    <span class="text-2xl font-extrabold leading-none my-1"><?php echo e($agenda->created_at->format('d')); ?></span>
                                </div>
                                <div class="p-4 flex-1">
                                    <h4 class="font-bold text-slate-900 group-hover:text-red-600 transition-colors line-clamp-1"><?php echo e($agenda->title); ?></h4>
                                    <div class="mt-2 text-xs text-slate-500 flex flex-col space-y-1">
                                        <span class="flex items-center"><svg class="w-3.5 h-3.5 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> Diumumkan <?php echo e($agenda->created_at->diffForHumans()); ?></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($agenda->file_attachment): ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginal074a021b9d42f490272b5eefda63257c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal074a021b9d42f490272b5eefda63257c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Belum Ada Agenda','message' => 'Belum ada agenda atau pengumuman.','icon' => 'calendar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('empty-state'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Agenda','message' => 'Belum ada agenda atau pengumuman.','icon' => 'calendar']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <div class="mt-8 text-center sm:hidden">
                <a href="<?php echo e(route('news.index') ?? '/berita'); ?>" class="inline-flex items-center justify-center px-4 py-2 border border-slate-200 rounded-lg text-sm font-bold bg-white text-slate-900 w-full shadow-sm">
                    Lihat Semua Berita
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                ...
                <div class="flex flex-col">
                    ...
                    <div x-data="{ loaded: false, videoId: '<?php echo e($settings->get('youtube_video_id', 'dQw4w9WgXcQ')); ?>' }" class="relative aspect-video rounded-2xl overflow-hidden shadow-2xl bg-slate-800 border-4 border-slate-800 group h-full max-h-[350px]">
                        <!-- Thumbnail Overlay -->
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        ...
                        <a href="<?php echo e($settings->get('social_youtube', 'https://youtube.com')); ?>" target="_blank" rel="noopener noreferrer" class="text-sm font-bold text-red-500 hover:text-white transition-colors flex items-center">
                            Subscribe
                ...
                <div class="flex flex-col">
                    <div class="flex justify-between items-end mb-8">
                        ...
                        <a href="<?php echo e(route('gallery.index') ?? '/galeri'); ?>" class="hidden sm:flex items-center text-sm font-bold text-slate-400 hover:text-white transition-colors">
                            Lihat Semua Foto
                            <svg class="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                        </a>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 h-full max-h-[350px]">
                        ...
                        <a href="<?php echo e(route('gallery.show', $firstGallery->slug) ?? '#'); ?>" class="block relative rounded-2xl overflow-hidden group shadow-lg row-span-2 focus-visible:ring-4 focus-visible:ring-red-500 focus:outline-none">
                            <img src="<?php echo e($firstGallery->thumbnail ? Storage::url($firstGallery->thumbnail) : 'https://images.unsplash.com/photo-1532522714596-f94be6a2fa59?q=80&w=600&auto=format&fit=crop'); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 opacity-80 group-hover:opacity-100" alt="<?php echo e($firstGallery->title); ?>" loading="lazy">
                            ...
                            <div class="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0">
                                <span class="text-white font-bold text-sm"><?php echo e($firstGallery->title); ?></span>
                            </div>
                        </a>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($galleries->count() > 1): ?>
                        <?php $secondGallery = $galleries->skip(1)->first(); ?>
                        <a href="<?php echo e(route('gallery.show', $secondGallery->slug) ?? '#'); ?>" class="block relative rounded-2xl overflow-hidden group shadow-lg focus-visible:ring-4 focus-visible:ring-red-500 focus:outline-none">
                            <img src="<?php echo e($secondGallery->thumbnail ? Storage::url($secondGallery->thumbnail) : 'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?q=80&w=400&auto=format&fit=crop'); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 opacity-80 group-hover:opacity-100" alt="<?php echo e($secondGallery->title); ?>" loading="lazy">
                            <div class="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            <div class="absolute bottom-3 left-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0">
                                <span class="text-white font-bold text-xs"><?php echo e($secondGallery->title); ?></span>
                            </div>
                        </a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <a href="<?php echo e(route('gallery.index') ?? '/galeri'); ?>" class="block relative rounded-2xl overflow-hidden group shadow-lg flex items-center justify-center bg-slate-800 hover:bg-slate-700 transition-colors border border-slate-700 focus-visible:ring-4 focus-visible:ring-red-500 focus:outline-none">
                            <div class="text-center">
                                <span class="block text-xl font-bold text-white mb-1">+<?php echo e(\App\Models\GalleryAlbum::count()); ?></span>
            ...
            <div class="mt-8 text-center sm:hidden">
                <a href="<?php echo e(route('gallery.index') ?? '/galeri'); ?>" class="inline-flex items-center justify-center px-4 py-2 border border-slate-700 rounded-lg text-sm font-bold bg-slate-800 text-white w-full shadow-sm">
                    Lihat Semua Foto
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
                ...
                <div class="w-full md:w-auto flex-shrink-0 relative z-10">
                    <a href="<?php echo e(route('download.index') ?? '/download'); ?>" class="inline-flex justify-center items-center px-6 py-3 bg-white border border-slate-300 text-sm font-bold text-slate-700 rounded-lg hover:bg-slate-50 hover:text-red-600 transition-colors w-full shadow-sm">
    ...
    <section class="relative bg-red-700 py-16 md:py-24 overflow-hidden">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="<?php echo e(route('about') ?? '/profil'); ?>" class="inline-flex justify-center items-center px-8 py-4 bg-white text-red-700 font-bold rounded-xl hover:bg-slate-100 hover:scale-105 transition-all shadow-xl shadow-red-900/20 focus:outline-none focus:ring-4 focus:ring-white">
                    Jelajahi Jurusan
                </a>
                <a href="<?php echo e(route('partnership.index') ?? '/kemitraan'); ?>" class="inline-flex justify-center items-center px-8 py-4 bg-transparent border-2 border-white/50 text-white font-bold rounded-xl hover:bg-white/10 hover:border-white transition-all focus:outline-none focus:ring-4 focus:ring-white">
                    Hubungi Kami
                </a>
            </div>
        </div>
