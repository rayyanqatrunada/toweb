...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.breadcrumbs','data' => ['items' => ['Lowongan Kerja' => route('jobs.index')]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Lowongan Kerja' => route('jobs.index')])]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                        ...
                        <div class="flex-shrink-0 flex items-start justify-center md:justify-start">
                            <div class="w-20 h-20 md:w-24 md:h-24 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center overflow-hidden">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->industryPartner && $job->industryPartner->logo): ?>
                                    <img src="<?php echo e(Storage::url($job->industryPartner->logo)); ?>" alt="<?php echo e($job->industryPartner->name); ?>" class="w-full h-full object-contain p-2">
                                <?php else: ?>
                            ...
                            <div class="flex flex-col md:flex-row md:justify-between items-start mb-2 gap-4">
                                <div>
                                    <h2 class="text-2xl font-bold text-slate-900 group-hover:text-red-600 transition-colors leading-tight mb-1">
                                        <a href="<?php echo e(route('jobs.show', $job->slug)); ?>" class="focus:outline-none"><?php echo e($job->title); ?></a>
                                    </h2>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->application_deadline): ?>
                                    <div class="bg-red-50 border border-red-100 px-4 py-2 rounded-lg text-center md:text-right shrink-0">
                                        ...
                                        <span class="block text-sm font-bold text-red-700"><?php echo e($job->application_deadline->translatedFormat('d M Y')); ?></span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'Belum Ada Lowongan Pekerjaan','message' => 'Lowongan pekerjaan dari mitra industri belum tersedia saat ini.','icon' => 'document']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Lowongan Pekerjaan','message' => 'Lowongan pekerjaan dari mitra industri belum tersedia saat ini.','icon' => 'document']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
