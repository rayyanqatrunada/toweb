...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "WebPage",
      "name": "Program & Kurikulum Akademik <?php echo e($settings->get('site_short_name', 'TSM')); ?>",
      "description": "Struktur kurikulum, spesifikasi kompetensi, sertifikasi industri, dan program unggulan <?php echo e($settings->get('site_name', 'Teknik Sepeda Motor')); ?> SMK Negeri 1 Bangsri binaan Astra Honda Motor."
    }
    </script>
    <?php $__env->stopPush(); ?>
                    ...
                    <div class="bg-white rounded-3xl p-6 border border-charcoal-200 shadow-sm">
                        ...
                        <div class="grid grid-cols-2 gap-3 text-center">
                            <div class="bg-charcoal-50 rounded-2xl p-3.5 border border-charcoal-100">
                                <span class="block text-2xl lg:text-3xl font-black text-primary-600"><?php echo e($settings->get('academic_praktikum_pct', '70%')); ?></span>
                            ...
                            <div class="bg-charcoal-50 rounded-2xl p-3.5 border border-charcoal-100">
                                <span class="block text-2xl lg:text-3xl font-black text-charcoal-900"><?php echo e($settings->get('academic_teori_pct', '30%')); ?></span>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <div id="<?php echo e($program->slug); ?>" class="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-10 reveal-on-scroll reveal-up">
                    ...
                    <div class="lg:col-span-7 bg-white rounded-3xl p-6 lg:p-8 border border-charcoal-200 shadow-sm flex flex-col justify-between">
                        <div>
                            ...
                            <p class="text-sm text-charcoal-600 leading-relaxed mb-6">
                                Program studi <?php echo e($settings->get('site_name', 'Teknik Sepeda Motor')); ?> (<?php echo e($settings->get('site_short_name', 'TSM')); ?>) membekali peserta didik dengan keahlian teknis perawatan motor injeksi mutakhir, didukung ekosistem bengkel nyata di sekolah.
                            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 reveal-on-scroll reveal-up delay-100">
                ...
                <div class="bg-charcoal-50 rounded-3xl p-6 lg:p-8 border border-charcoal-200 hover:border-primary-600 transition-all flex flex-col justify-between group">
                    <div>
                        ...
                        <h3 class="text-xl font-black text-charcoal-950 uppercase tracking-tight mt-1 mb-2"><?php echo e($settings->get('academic_prog_honda_title', 'Kelas Industri Honda')); ?></h3>
                        <p class="text-xs text-charcoal-600 leading-relaxed mb-4">
                    ...
                    <div class="pt-4 border-t border-charcoal-200 text-xs font-bold text-charcoal-700 flex items-center gap-2">
                        ...
                        <span><?php echo e($settings->get('academic_prog_honda_tag', 'Standar bengkel resmi AHASS')); ?></span>
                    </div>
                </div>
                ...
                <div class="bg-charcoal-50 rounded-3xl p-6 lg:p-8 border border-charcoal-200 hover:border-primary-600 transition-all flex flex-col justify-between group">
                    <div>
                        ...
                        <h3 class="text-xl font-black text-charcoal-950 uppercase tracking-tight mt-1 mb-2"><?php echo e($settings->get('academic_prog_tefa_title', 'Teaching Factory (TeFa)')); ?></h3>
                        <p class="text-xs text-charcoal-600 leading-relaxed mb-4">
                    ...
                    <div class="pt-4 border-t border-charcoal-200 text-xs font-bold text-charcoal-700 flex items-center gap-2">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary-600 shrink-0"></span>
                        <span><?php echo e($settings->get('academic_prog_tefa_tag', 'Pengalaman servis pelanggan riil')); ?></span>
                    </div>
                </div>
                ...
                <div class="bg-charcoal-50 rounded-3xl p-6 lg:p-8 border border-charcoal-200 hover:border-primary-600 transition-all flex flex-col justify-between group">
                    <div>
                        ...
                        <h3 class="text-xl font-black text-charcoal-950 uppercase tracking-tight mt-1 mb-2"><?php echo e($settings->get('academic_prog_pkl_title', 'Magang PKL di AHASS')); ?></h3>
                        <p class="text-xs text-charcoal-600 leading-relaxed mb-4">
                    ...
                    <div class="pt-4 border-t border-charcoal-200 text-xs font-bold text-charcoal-700 flex items-center gap-2">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary-600 shrink-0"></span>
                        <span><?php echo e($settings->get('academic_prog_pkl_tag', 'Durasi 6 bulan di bengkel resmi')); ?></span>
                    </div>
                </div>
                ...
                <div class="bg-charcoal-50 rounded-3xl p-6 lg:p-8 border border-charcoal-200 hover:border-primary-600 transition-all flex flex-col justify-between group">
                    <div>
                        ...
                        <span class="text-[10px] font-black uppercase tracking-widest text-primary-600"><?php echo e($settings->get('academic_prog_safety_badge', 'Juara Karesidenan & Nasional')); ?></span>
                        <h3 class="text-xl font-black text-charcoal-950 uppercase tracking-tight mt-1 mb-2"><?php echo e($settings->get('academic_prog_safety_title', 'Safety Riding Academy')); ?></h3>
                        <p class="text-xs text-charcoal-600 leading-relaxed mb-4">
                    ...
                    <div class="pt-4 border-t border-charcoal-200 text-xs font-bold text-charcoal-700 flex items-center gap-2">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary-600 shrink-0"></span>
                        <span><?php echo e($settings->get('academic_prog_safety_tag', 'Pelatihan keselamatan bersertifikat')); ?></span>
                    </div>
                </div>
                ...
                <div class="bg-charcoal-50 rounded-3xl p-6 lg:p-8 border border-charcoal-200 hover:border-primary-600 transition-all flex flex-col justify-between group">
                    <div>
                        ...
                        <h3 class="text-xl font-black text-charcoal-950 uppercase tracking-tight mt-1 mb-2"><?php echo e($settings->get('academic_prog_5r_title', 'Budaya Industri 5R & APD')); ?></h3>
                        <p class="text-xs text-charcoal-600 leading-relaxed mb-4">
                    ...
                    <div class="pt-4 border-t border-charcoal-200 text-xs font-bold text-charcoal-700 flex items-center gap-2">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary-600 shrink-0"></span>
                        <span><?php echo e($settings->get('academic_prog_5r_tag', 'Standar K3LH & kedisiplinan kerja')); ?></span>
                    </div>
                </div>
                ...
                <div class="bg-charcoal-50 rounded-3xl p-6 lg:p-8 border border-charcoal-200 hover:border-primary-600 transition-all flex flex-col justify-between group">
                    <div>
                        ...
                        <h3 class="text-xl font-black text-charcoal-950 uppercase tracking-tight mt-1 mb-2"><?php echo e($settings->get('academic_prog_lks_title', 'Lomba LKS & Kontes Honda')); ?></h3>
                        <p class="text-xs text-charcoal-600 leading-relaxed mb-4">
                    ...
                    <div class="pt-4 border-t border-charcoal-200 text-xs font-bold text-charcoal-700 flex items-center gap-2">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary-600 shrink-0"></span>
                        <span><?php echo e($settings->get('academic_prog_lks_tag', 'Tradisi juara LKS & Astra Motor')); ?></span>
                    </div>
                </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="max-w-3xl mb-12 reveal-on-scroll reveal-up">
                ...
                <p class="mt-3 text-base text-charcoal-600 leading-relaxed">
                    Penguasaan keterampilan mekanik presisi dan pemahaman bisnis perbengkelan membuka tiga jalur utama karir lulusan <?php echo e($settings->get('site_short_name', 'TSM')); ?> SMK Negeri 1 Bangsri.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 reveal-on-scroll reveal-up delay-100">
                ...
                <div class="bg-white rounded-3xl p-6 lg:p-8 border border-charcoal-200 hover:border-primary-600 transition-all flex flex-col justify-between group shadow-2xs">
                    ...
                    <div class="pt-4 border-t border-charcoal-100 text-xs space-y-1.5">
                        ...
                        <div class="text-charcoal-600"><?php echo e($settings->get('academic_career_1_ladder', 'Mekanik Pratama → Senior Mechanic → Service Advisor → Kepala Bengkel')); ?></div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl p-6 lg:p-8 border border-charcoal-200 hover:border-primary-600 transition-all flex flex-col justify-between group shadow-2xs">
                    ...
                    <div class="pt-4 border-t border-charcoal-100 text-xs space-y-1.5">
                        ...
                        <div class="text-charcoal-600"><?php echo e($settings->get('academic_career_2_placement', 'Pabrik Manufaktur Otomotif, Operator Lini Perakitan, Teknisi Quality Control')); ?></div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl p-6 lg:p-8 border border-charcoal-200 hover:border-primary-600 transition-all flex flex-col justify-between group shadow-2xs">
                    ...
                    <div class="pt-4 border-t border-charcoal-100 text-xs space-y-1.5">
                        ...
                        <div class="text-charcoal-600"><?php echo e($settings->get('academic_career_3_skills', 'Pengelolaan Bengkel, Estimasi Biaya Servis, Manajemen Toko Spare Parts')); ?></div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-3xl p-6 lg:p-10 border border-charcoal-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8 reveal-on-scroll reveal-up">
                <div class="max-w-2xl">
                    ...
                    <p class="text-xs sm:text-sm text-charcoal-600 leading-relaxed">
                        <?php echo e($settings->get('academic_teacher_desc', 'Guru kejuruan dan instruktur ' . $settings->get('site_short_name', 'TSM') . ' SMK Negeri 1 Bangsri rutin mengikuti program peningkatan kompetensi dan sertifikasi berjenjang di Astra Motor Training Center.')); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight leading-tight mb-6">
                <?php echo e($settings->get('academic_cta_title', 'Wujudkan Masa Depan Teknisi Andal Bersama ' . $settings->get('site_short_name', 'TSM') . ' SMKN 1 Bangsri')); ?>
        ...
        <div class="bg-white rounded-3xl max-w-2xl w-full max-h-[85vh] overflow-y-auto p-6 lg:p-8 border border-charcoal-200 shadow-2xl relative">
            <div class="flex items-center justify-between pb-4 mb-6 border-b border-charcoal-100">
                <div>
                    ...
                    <h3 class="text-xl font-black text-charcoal-900 uppercase">Struktur Kurikulum <?php echo e($settings->get('site_short_name', 'TSM')); ?></h3>
                </div>
            ...
            <div class="space-y-4 text-xs text-charcoal-700 leading-relaxed">
                <p>
                    <?php echo e($settings->get('academic_syllabus_modal_intro', 'Kurikulum ' . $settings->get('site_name', 'Teknik Sepeda Motor') . ' (' . $settings->get('site_short_name', 'TSM') . ') SMK Negeri 1 Bangsri dirancang berdasarkan Kepmendikbudristek Kurikulum Merdeka yang diselaraskan secara konsisten dengan kompetensi industri PT Astra Honda Motor.')); ?>
