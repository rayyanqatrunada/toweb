    ...
    <div class="max-w-[1280px] mx-auto px-6 md:px-16 py-10">
        <div class="flex flex-col lg:flex-row justify-between gap-8">
            ...
            <div class="flex flex-col gap-4 w-full max-w-[384px]">
                <a href="<?php echo e(route('home')); ?>" class="font-heading font-extrabold text-[20px] text-figma-bg-card leading-[28px]">
                    Teknik Otomotif
                </a>
    ...
    <div class="bg-[#101011] border-t border-figma-gray-dark">
        <div class="max-w-[1280px] mx-auto px-6 md:px-16 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="font-sans text-[14px] text-figma-gray">
                &copy; <?php echo e(date('Y')); ?> <?php echo e($settings->get('site_name', 'Teknik Otomotif')); ?>. Seluruh Hak Cipta Dilindungi.
            </p>
