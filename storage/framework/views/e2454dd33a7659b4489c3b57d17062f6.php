...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div class="py-12 lg:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
            ...
            <div class="lg:col-span-4 lg:pr-8">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 mb-6 focus-ring rounded-lg py-1 px-1 -ml-1 group w-fit">
                    ...
                    <div class="flex flex-col">
                        <span class="font-bold text-xl text-white tracking-tight leading-none group-hover:text-charcoal-200 transition-colors"><?php echo e($settings->get('site_name', 'Teknik Otomotif')); ?></span>
                        <span class="text-[10px] font-semibold text-charcoal-500 uppercase tracking-widest mt-0.5">Sekolah Vokasi</span>
                    </div>
                </a>
                <p class="text-sm leading-relaxed mb-6">
                    <?php echo e($settings->get('site_description', 'Program Keahlian Teknik Otomotif berdedikasi untuk mencetak mekanik dan ahli otomotif masa depan yang kompeten, disiplin, dan siap kerja di dunia industri modern.')); ?>
            ...
            <div class="lg:col-span-2 lg:col-start-6">
                ...
                <ul class="space-y-3">
                    <li><a href="<?php echo e(route('about')); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md">Tentang</a></li>
                    <li><a href="<?php echo e(route('academic.programs')); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md">Program</a></li>
                    <li><a href="<?php echo e(route('academic.teachers')); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md">Guru & Staf</a></li>
                    <li><a href="<?php echo e(route('academic.facilities')); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md">Fasilitas</a></li>
                    <li><a href="<?php echo e(route('news.index')); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md">Berita</a></li>
                </ul>
            </div>
            ...
            <div class="lg:col-span-2">
                ...
                <ul class="space-y-3">
                    <li><a href="<?php echo e(route('internships.index')); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md">PKL</a></li>
                    <li><a href="<?php echo e(route('jobs.index')); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md">Lowongan Kerja</a></li>
                    <li><a href="<?php echo e(route('alumni.index')); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md">Alumni</a></li>
                    <li><a href="<?php echo e(route('download.index')); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md">Unduhan</a></li>
                </ul>
            </div>
            ...
            <div class="lg:col-span-3">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-sm"><?php echo e($settings->get('contact_address', 'Jl. Pendidikan No. 1, Kota Belajar')); ?></span>
                    </li>
                    <li class="flex items-center gap-3">
                        <svg class="h-5 w-5 shrink-0 text-charcoal-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                        <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $settings->get('contact_phone', '(021) 123-4567'))); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md"><?php echo e($settings->get('contact_phone', '(021) 123-4567')); ?></a>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:<?php echo e($settings->get('contact_email', 'info@otomotif.sch.id')); ?>" class="text-sm hover:text-white hover:underline transition-colors focus-ring rounded-md"><?php echo e($settings->get('contact_email', 'info@otomotif.sch.id')); ?></a>
                    </li>
                </ul>
            </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <p class="text-sm text-charcoal-500">
                    &copy; <?php echo e(date('Y')); ?> <span class="text-charcoal-300"><?php echo e($settings->get('site_name', 'Teknik Otomotif')); ?></span>. Hak cipta dilindungi.
                </p>
