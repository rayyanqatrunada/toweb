        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($galleries && $galleries->count() > 0): ?>
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2.5 sm:gap-6 reveal-on-scroll reveal-up delay-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('gallery.show', $gallery->slug)); ?>" class="block relative group overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 bg-charcoal-900 rounded-xl sm:rounded-none aspect-[4/3] sm:aspect-square active:scale-[0.98]">
                        ...
                        <div class="absolute bottom-0 left-0 w-full p-2.5 sm:p-5 sm:translate-y-2 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100 transition-all duration-300 z-10">
                            <h3 class="font-heading font-bold text-[12px] sm:text-[16px] text-white leading-tight mb-0.5 sm:mb-1 line-clamp-2"><?php echo e($gallery->title); ?></h3>
