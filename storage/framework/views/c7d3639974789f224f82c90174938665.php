        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($galleries && $galleries->count() > 0): ?>
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6 reveal-on-scroll reveal-up delay-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('gallery.show', $gallery->slug)); ?>" class="block relative group overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 bg-charcoal-900 rounded-lg sm:rounded-none aspect-[4/3] sm:aspect-square">
                        ...
                        <div class="absolute bottom-0 left-0 w-full p-3 sm:p-5 sm:translate-y-2 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100 transition-all duration-300 z-10">
                            <h3 class="font-heading font-bold text-[13px] sm:text-[16px] text-white leading-tight mb-1 line-clamp-2"><?php echo e($gallery->title); ?></h3>
            ...
            <div class="mt-8 sm:mt-12 md:mt-16 text-center">
                <a href="<?php echo e(route('gallery.index')); ?>" class="inline-flex items-center justify-center w-full sm:w-auto px-6 sm:px-8 py-3.5 border-2 border-figma-dark text-figma-dark font-sans font-bold text-[13px] sm:text-[14px] uppercase tracking-wide hover:bg-figma-dark hover:text-white transition-colors focus-ring rounded-sm">
