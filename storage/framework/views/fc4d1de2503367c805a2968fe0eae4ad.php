...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-6 space-y-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $albums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('gallery.show', $album->slug)); ?>" class="group block break-inside-avoid relative rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:border-charcoal-300 hover:-translate-y-1 transition-all duration-500 bg-charcoal-100 border border-charcoal-200 reveal-on-scroll reveal-up">
                        
                        <!-- Cover Image with Natural Aspect Ratio -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($album->thumbnail && Storage::disk('public')->exists($album->thumbnail)): ?>
                            <img src="<?php echo e(Storage::url($album->thumbnail)); ?>" alt="<?php echo e($album->title); ?>" class="w-full h-auto min-h-[300px] max-h-[450px] object-cover group-hover:scale-105 transition-transform duration-700 filter group-hover:contrast-110" loading="lazy">
                        <?php elseif(isset($album->featuredImage) && $album->featuredImage->file_path && Storage::disk('public')->exists($album->featuredImage->file_path)): ?>
                            <img src="<?php echo e(Storage::url($album->featuredImage->file_path)); ?>" alt="<?php echo e($album->title); ?>" class="w-full h-auto min-h-[300px] max-h-[450px] object-cover group-hover:scale-105 transition-transform duration-700 filter group-hover:contrast-110" loading="lazy">
                        <?php else: ?>
