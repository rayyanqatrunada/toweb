...
class Login extends BaseLogin
{
    ...
    {
        return new \Illuminate\Support\HtmlString('<div class="flex items-center justify-center mb-4"><div class="w-16 h-16 rounded-xl flex items-center justify-center text-white font-black text-2xl shadow-lg" style="background:linear-gradient(135deg,#071BAE,#0A24DB)">TBSM</div></div><h2 class="text-2xl font-black tracking-tight text-center">Portal Administrasi</h2><p class="text-sm text-center text-slate-400 mt-1">Teknik dan Bisnis Sepeda Motor &mdash; Masuk ke panel pengelolaan</p>');
    }
